...
export const elimikaDesignSystem = {
  ...
  components: {
    ...
    header: {
      ...
      badge: 'inline-flex items-center gap-2 rounded-full border border-blue-400/40 bg-blue-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.4em] text-blue-600 dark:border-blue-500/40 dark:bg-blue-900/40 dark:text-blue-100',
    },

    // Form container
    form: {
      wrapper: 'space-y-8 rounded-[32px] border border-blue-200/40 bg-gradient-to-br from-white via-blue-50 to-blue-100/60 p-6 shadow-xl shadow-blue-200/40 transition dark:border-blue-500/25 dark:from-blue-950/60 dark:via-blue-900/40 dark:to-slate-950/80 dark:shadow-blue-900/20 lg:p-10',
    },

    // Form section (with sidebar title)
    formSection: {
      wrapper: 'rounded-3xl border border-blue-200/40 bg-white/90 p-6 shadow-lg shadow-blue-200/40 transition dark:border-blue-500/25 dark:bg-blue-950/30 lg:p-8',
      container: 'flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-10',
      sidebar: 'lg:w-1/3',
      sidebarBadge: 'text-xs font-semibold uppercase tracking-[0.4em] text-blue-500/80 dark:text-blue-200',
    ...
    card: {
      ...
      header: 'mb-5 inline-flex items-center justify-center rounded-full bg-blue-500/15 p-3 text-blue-700 dark:text-blue-300',
    ...
    // Loading/Empty state
    emptyState: {
      container: 'flex min-h-[280px] flex-col items-center justify-center gap-4 rounded-[28px] border border-blue-200/40 bg-gradient-to-br from-white via-blue-50 to-blue-100/60 px-6 py-12 text-center shadow-lg shadow-blue-200/40 backdrop-blur dark:border-blue-500/25 dark:from-blue-950/60 dark:via-blue-900/40 dark:to-slate-950/80 dark:text-slate-200 dark:shadow-blue-900/20',
    ...
    // Badge variants
    badge: {
      primary: 'rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-xs font-semibold text-blue-700 dark:border-blue-500/40 dark:bg-blue-900/40 dark:text-blue-100',
      secondary: 'rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold text-slate-700 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200',
    },

    // Button variants (extends default shadcn)
    button: {
      primary: 'rounded-full bg-blue-600 px-7 py-3 text-sm font-medium text-white shadow hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600',
      secondary: 'rounded-full border border-blue-200 bg-white px-7 py-3 text-sm font-medium text-blue-700 shadow hover:border-blue-400 hover:text-blue-900 dark:border-blue-500/40 dark:bg-blue-950/40 dark:text-blue-100 dark:hover:border-blue-400',
    },
