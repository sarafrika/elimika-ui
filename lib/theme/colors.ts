...
export const elimikaPalette = {
  ...
  semantic,
  gradients: {
    heroLight: 'linear-gradient(135deg, rgba(31,116,255,0.12), rgba(26,215,207,0.05))',
    heroDark: 'linear-gradient(135deg, rgba(26,215,207,0.1), rgba(17,100,215,0.3))',
    cardLight: 'linear-gradient(145deg, rgba(255,255,255,0.95), rgba(31,116,255,0.05))',
    cardDark: 'linear-gradient(145deg, rgba(15,31,43,0.92), rgba(31,116,255,0.08))',
  },
} as const;
