...
const TrainingBranch = z
  .object({
    ...
    branch_name: z.string().min(0).max(200),
...
const Student = z
  .object({
    ...
    first_guardian_name: z.string().min(0).max(100).optional(),
...
const Quiz = z
  .object({
    ...
    instructions: z.string().min(0).max(1000).optional(),
    time_limit_minutes: z.number().int().gte(1).optional(),
    ...
    time_limit_display: z.string().optional(),
...
const QuizQuestion = z
  .object({
    ...
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
    requires_options: z.boolean().optional(),
...
const QuizQuestionOption = z
  .object({
    ...
    option_text: z.string().min(0).max(1000),
    is_correct: z.boolean().optional(),
    display_order: z.number().int().gte(1).optional(),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
    option_category: z.string().optional(),
    is_incorrect: z.boolean().optional(),
...
const ProgramCourse = z
  .object({
    ...
    sequence_order: z.number().int().gte(1).optional(),
    is_required: z.boolean().optional(),
    prerequisite_course_uuid: z.string().uuid().optional(),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
    association_category: z.string().optional(),
    has_prerequisites: z.boolean().optional(),
    sequence_display: z.string().optional(),
...
const Organisation = z
  .object({
    ...
    licence_no: z.string().max(100).optional(),
...
const Instructor = z
  .object({
    ...
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
    has_location_coordinates: z.boolean().optional(),
...
const InstructorExperience = z
  .object({
    ...
    organization_name: z.string().min(0).max(255),
    responsibilities: z.string().min(0).max(2000).optional(),
    years_of_experience: z.number().gte(0).lte(50).optional(),
    start_date: z.string().optional(),
    end_date: z.string().optional(),
...
const InstructorEducation = z
  .object({
    ...
    year_completed: z.number().int().gte(1950).lte(2030).optional(),
...
const InstructorDocument = z
  .object({
    ...
    file_size_bytes: z.number().int().gte(1).optional(),
    mime_type: z.string().optional(),
    file_hash: z.string().optional(),
    upload_date: z.string().datetime({ offset: true }).optional(),
...
const Course = z
  .object({
    ...
    description: z.string().min(0).max(2000).optional(),
    objectives: z.string().min(0).max(1000).optional(),
    prerequisites: z.string().min(0).max(1000).optional(),
    duration_hours: z.number().int().gte(0),
    duration_minutes: z.number().int().gte(0).lte(59),
    class_limit: z.number().int().gte(1).optional(),
    price: z.number().gte(0).optional(),
    age_lower_limit: z.number().int().gte(1).lte(120).optional(),
    age_upper_limit: z.number().int().gte(1).lte(120).optional(),
    ...
    is_in_review: z.boolean().optional(),
    is_draft: z.boolean().optional(),
    total_duration_display: z.string().optional(),
    has_multiple_categories: z.boolean().optional(),
...
const Lesson = z
  .object({
    uuid: z.string().uuid().optional(),
    course_uuid: z.string().uuid(),
    lesson_number: z.number().int().gte(1),
    title: z.string().min(0).max(255),
    duration_hours: z.number().int().gte(0),
    duration_minutes: z.number().int().gte(0).lte(59),
    description: z.string().min(0).max(1000).optional(),
...
const LessonContent = z
  .object({
    ...
    file_url: z.string().min(0).max(500).url().optional(),
    display_order: z.number().int().gte(1),
    is_required: z.boolean().optional(),
    file_size_bytes: z.number().int().gte(0).optional(),
    mime_type: z.string().optional(),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
    updated_date: z.string().datetime({ offset: true }).optional(),
...
const CourseAssessment = z
  .object({
    ...
    title: z.string().min(0).max(255),
    description: z.string().min(0).max(1000).optional(),
    weight_percentage: z.number().gte(0).lte(100),
    rubric_uuid: z.string().uuid().optional(),
    is_required: z.boolean().optional(),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
...
const GradingLevel = z
  .object({
    uuid: z.string().uuid().optional(),
    name: z.string().min(0).max(50),
    points: z.number().int().gte(1).lte(10),
    level_order: z.number().int().gte(1).lte(10),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
...
const ContentType = z
  .object({
    uuid: z.string().uuid().optional(),
    name: z.string().min(0).max(50),
    mime_types: z.array(z.string()).min(1).max(2147483647),
    max_file_size_mb: z.number().int().gte(1).optional(),
    created_date: z.string().datetime({ offset: true }).optional(),
    created_by: z.string().optional(),
    updated_date: z.string().datetime({ offset: true }).optional(),
    updated_by: z.string().optional(),
    upload_category: z.string().optional(),
    is_media_type: z.boolean().optional(),
...
const Certificate = z
  .object({
    ...
    completion_date: z.string().datetime({ offset: true }),
    final_grade: z.number().gte(0).lte(100).optional(),
    is_valid: z.boolean().optional(),
    certificate_number: z.string().optional(),
    issued_date: z.string().datetime({ offset: true }).optional(),
...
const Assignment = z
  .object({
    ...
    title: z.string().min(0).max(255),
    description: z.string().min(0).max(2000).optional(),
    instructions: z.string().min(0).max(5000).optional(),
    due_date: z.string().datetime({ offset: true }).optional(),
    max_points: z.number().gte(0).optional(),
    rubric_uuid: z.string().uuid().optional(),
