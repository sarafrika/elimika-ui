...
export const TrainingBranchSchema = {
    ...
    required: ['active', 'branch_name', 'organisation_uuid', 'poc_email', 'poc_name', 'poc_telephone']
} as const;
...
export const TrainingProgramSchema = {
    ...
    required: ['course_creator_uuid', 'published', 'status', 'title', 'total_duration_hours', 'total_duration_minutes']
} as const;
...
export const OrganisationSchema = {
    ...
    properties: {
        ...
        admin_verified: {
            type: 'boolean',
            description: '**[READ-ONLY]** Indicates whether the organisation has been verified/approved by an admin. Only verified organisations can access certain platform features and are displayed with verification badges.',
            example: true,
            readOnly: true
        },
        created_date: {
...
export const CourseSchema = {
    ...
    example: {
        ...
        category_uuids: ['c1a2t3e4-5g6o-7r8y-9a10-abcdefghijkl', 'p1r2o3g4-5r6a-7m8m-9i10-abcdefghijkl'],
    ...
    required: ['course_creator_uuid', 'creator_share_percentage', 'duration_hours', 'duration_minutes', 'instructor_share_percentage', 'name', 'status']
} as const;
...
export const ClassDefinitionSchema = {
    ...
    properties: {
        ...
        location_name: {
            type: 'string',
            description: '**[OPTIONAL]** Human-readable name for the primary class location, used for Mapbox forward/reverse geocoding (e.g., campus, room, or venue name). Required when location_type is IN_PERSON or HYBRID.',
            example: 'Nairobi HQ – Room 101',
            maxLength: 255
        },
        location_latitude: {
            type: 'number',
            description: '**[OPTIONAL]** Latitude coordinate for the primary class location, used with Mapbox. Required when location_type is IN_PERSON or HYBRID.',
            example: -1.292066
        },
        location_longitude: {
            type: 'number',
            description: '**[OPTIONAL]** Longitude coordinate for the primary class location, used with Mapbox. Required when location_type is IN_PERSON or HYBRID.',
            example: 36.821945
        },
        meeting_link: {
            type: 'string',
...
export const ClassMarketplaceJobRequestSchema = {
    ...
    properties: {
        ...
        session_templates: {
            type: 'array',
            description: '**[REQUIRED]** Session templates that will be used when the class is assigned and created.',
            items: {
                '$ref': '#/components/schemas/ClassSessionTemplate'
            },
            maxItems: 2147483647,
    ...
    required: ['class_visibility', 'course_uuid', 'default_end_time', 'default_start_time', 'location_type', 'organisation_uuid', 'session_format', 'session_templates', 'title']
} as const;
...
export const CourseTrainingRateCardSchema = {
    ...
    required: ['group_inperson_rate', 'group_online_rate', 'private_inperson_rate', 'private_online_rate']
} as const;
...
export const CartItemResponseSchema = {
    ...
    properties: {
        ...
        metadata: {
            ...
            description: 'System-managed metadata describing the catalogue context for the line item (read-only)'
        }
    }
} as const;
...
export const BookingResponseSchema = {
    ...
    required: ['course_uuid', 'end_time', 'instructor_uuid', 'start_time', 'status', 'student_uuid', 'uuid']
} as const;
...
export const InstructorCalendarEntrySchema = {
    ...
    properties: {
        uuid: {
            type: 'string',
            format: 'uuid',
            description: 'Unique identifier for the entry (slot UUID or scheduled instance UUID where applicable)'
        },
        entry_type: {
        ...
        is_available: {
            type: 'boolean',
            description: 'Flag indicating availability; false represents blocked time or scheduled instances occupying the slot'
        },
        status: {
            '$ref': '#/components/schemas/StatusEnum6'
        },
...
export const AdminActivityEventSchema = {
    ...
    properties: {
        ...
        actor_domains: {
            type: 'string',
            description: 'Comma-separated list of domains attached to the administrator during the request'
        },
        request_id: {
            type: 'string',
...
export const OrganisationTypeEnumSchema = {
    ...
    enum: ['PROFESSIONAL_INSTITUTE', 'CERTIFICATION_BODY', 'INDUSTRY_ASSOCIATION', 'ACADEMIC_SOCIETY', 'TRADE_ORGANIZATION', 'OTHER'],
...
export const ItemTypeEnumSchema = {
    type: 'string',
    enum: ['assignment', 'quiz', 'attendance', 'project', 'discussion', 'exam', 'practical', 'performance', 'participation', 'manual']
} as const;
...
export const StatusEnum12Schema = {
    ...
    enum: ['payment_required', 'confirmed', 'cancelled', 'payment_failed', 'expired', 'accepted', 'declined', 'accepted_confirmed']
} as const;
