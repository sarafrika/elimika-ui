...
import type {
  ...
  GetClassEnrolmentEligibilityResponse,
...
export const updateProgramTrainingApplicationResponseTransformer = async (
  data: any
): Promise<UpdateProgramTrainingApplicationResponse> => {
  data = apiResponseProgramTrainingApplicationSchemaResponseTransformer(data);
  return data;
};
...
export const updateTrainingApplicationResponseTransformer = async (
  data: any
): Promise<UpdateTrainingApplicationResponse> => {
  data = apiResponseCourseTrainingApplicationSchemaResponseTransformer(data);
  return data;
};
...
export const listJobApplicationsResponseTransformer = async (
  data: any
...
const classRegistrationWindowSchemaResponseTransformer = (data: any) => {
  if (data.opens_on) {
    data.opens_on = new Date(data.opens_on);
  }
  if (data.closes_on) {
    data.closes_on = new Date(data.closes_on);
  }
  return data;
};

const classEnrolmentEligibilitySchemaResponseTransformer = (data: any) => {
  if (data.registration_window) {
    data.registration_window = classRegistrationWindowSchemaResponseTransformer(
      data.registration_window
    );
  }
  return data;
};

const apiResponseClassEnrolmentEligibilitySchemaResponseTransformer = (data: any) => {
  if (data.data) {
    data.data = classEnrolmentEligibilitySchemaResponseTransformer(data.data);
  }
  return data;
};

export const getClassEnrolmentEligibilityResponseTransformer = async (
  data: any
): Promise<GetClassEnrolmentEligibilityResponse> => {
  data = apiResponseClassEnrolmentEligibilitySchemaResponseTransformer(data);
  return data;
};
...
const courseTrainerSummarySchemaResponseTransformer = (data: any) => {
  ...
  if (data.active_class_count) {
    data.active_class_count = BigInt(data.active_class_count.toString());
  }
  return data;
};

const courseTrainerDirectorySchemaResponseTransformer = (data: any) => {
  if (data.trainers) {
    data.trainers = data.trainers.map((item: any) => {
      return courseTrainerSummarySchemaResponseTransformer(item);
    });
  }
  if (data.pending_count) {
    data.pending_count = BigInt(data.pending_count.toString());
  }
  return data;
};

const apiResponseCourseTrainerDirectorySchemaResponseTransformer = (data: any) => {
  if (data.data) {
    data.data = courseTrainerDirectorySchemaResponseTransformer(data.data);
  }
  return data;
};

export const getCourseTrainersResponseTransformer = async (
  data: any
): Promise<GetCourseTrainersResponse> => {
  data = apiResponseCourseTrainerDirectorySchemaResponseTransformer(data);
  return data;
};

const courseStatsPublicSchemaResponseTransformer = (data: any) => {
  if (data.learners_trained) {
    data.learners_trained = BigInt(data.learners_trained.toString());
  }
  if (data.classes_running) {
    data.classes_running = BigInt(data.classes_running.toString());
  }
  if (data.total_reviews) {
    data.total_reviews = BigInt(data.total_reviews.toString());
  }
  if (data.approved_trainer_count) {
    data.approved_trainer_count = BigInt(data.approved_trainer_count.toString());
  }
  return data;
};

const courseStatsScopedSchemaResponseTransformer = (data: any) => {
  if (data.your_learners) {
    data.your_learners = BigInt(data.your_learners.toString());
  }
  if (data.your_classes) {
    data.your_classes = BigInt(data.your_classes.toString());
  }
  return data;
};

const courseStatsOwnerSchemaResponseTransformer = (data: any) => {
  if (data.total_enrollments) {
    data.total_enrollments = BigInt(data.total_enrollments.toString());
  }
  if (data.paid_orders) {
    data.paid_orders = BigInt(data.paid_orders.toString());
  }
  if (data.refunded_orders) {
    data.refunded_orders = BigInt(data.refunded_orders.toString());
  }
  return data;
};

const courseStatsSchemaResponseTransformer = (data: any) => {
  if (data.public) {
    data.public = courseStatsPublicSchemaResponseTransformer(data.public);
  }
  if (data.scoped) {
    data.scoped = courseStatsScopedSchemaResponseTransformer(data.scoped);
  }
  if (data.owner) {
    data.owner = courseStatsOwnerSchemaResponseTransformer(data.owner);
  }
  return data;
};
...
export const getCourseContentResponseTransformer = async (
  data: any
...
export const listMyApplicationsResponseTransformer = async (
  data: any
