...
export const zStatusEnum = z
  ...
  .describe('**[REQUIRED]** Quiz publication status in the content workflow.');
...
export const zStatusEnum3 = z
  .enum(['draft', 'in_review', 'published', 'archived'])
  .describe('**[REQUIRED]** Course publication status in the content workflow.');
...
export const zApiResponseListContentStatus = z.object({
  success: z.boolean().optional(),
  data: z.array(zStatusEnum3).optional(),
  message: z.string().optional(),
  error: z.object({}).optional(),
});
 ...
 */
export const zDeleteTrainingProgramResponse = z.void().describe('Program deleted successfully');
 ...
 */
export const zCreateTrainingProgramResponse = z.string().describe('Program created successfully');
