...
import type {
  ...
  ApplyBulkActionData,
  ApplyBulkActionError,
  ApplyBulkActionResponse,
  ApplyActionData,
  ApplyActionError,
  ApplyActionResponse,
 ...
 */
export const getProgramReviewsOptions = (options: Options<GetProgramReviewsData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getProgramReviewsQueryKey(options),
  });
};

export const getProgramReviewsInfiniteQueryKey = (
  options: Options<GetProgramReviewsData>
): QueryKey<Options<GetProgramReviewsData>> => createQueryKey('getProgramReviews', options, true);

/**
 * Get reviews for a program
 * Returns paginated public reviews for the specified training program.
 */
export const getProgramReviewsInfiniteOptions = (options: Options<GetProgramReviewsData>) => {
  return infiniteQueryOptions<
    GetProgramReviewsResponse,
    GetProgramReviewsError,
    InfiniteData<GetProgramReviewsResponse>,
...
export const submitProgramReviewQueryKey = (options: Options<SubmitProgramReviewData>) =>
  createQueryKey('submitProgramReview', options);
 ...
 *
 */
export const submitProgramReviewOptions = (options: Options<SubmitProgramReviewData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await submitProgramReview({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: submitProgramReviewQueryKey(options),
  });
};
 ...
 *
 */
export const submitProgramReviewMutation = (
  options?: Partial<Options<SubmitProgramReviewData>>
): UseMutationOptions<
  SubmitProgramReviewResponse,
  SubmitProgramReviewError,
  Options<SubmitProgramReviewData>
> => {
  const mutationOptions: UseMutationOptions<
    SubmitProgramReviewResponse,
    SubmitProgramReviewError,
...
): QueryKey<Options<ListNotificationsData>> => createQueryKey('listNotifications', options, true);
...
export const applyBulkActionQueryKey = (options: Options<ApplyBulkActionData>) =>
  createQueryKey('applyBulkAction', options);
...
export const applyBulkActionOptions = (options: Options<ApplyBulkActionData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await applyBulkAction({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: applyBulkActionQueryKey(options),
  });
};
...
export const applyActionQueryKey = (options: Options<ApplyActionData>) =>
  createQueryKey('applyAction', options);

/**
 * Apply an action to one notification
 */
export const applyActionOptions = (options: Options<ApplyActionData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: applyActionQueryKey(options),
  });
};
 ...
 * Apply an action to one notification
 */
export const applyActionMutation = (
  options?: Partial<Options<ApplyActionData>>
): UseMutationOptions<ApplyActionResponse, ApplyActionError, Options<ApplyActionData>> => {
  const mutationOptions: UseMutationOptions<
    ApplyActionResponse,
    ApplyActionError,
    Options<ApplyActionData>
  > = {
    mutationFn: async localOptions => {
      const { data } = await applyAction({
        ...options,
...
export const submitGuardianDetailsQueryKey = (options: Options<SubmitGuardianDetailsData>) =>
  createQueryKey('submitGuardianDetails', options);
 ...
 */
export const submitGuardianDetailsOptions = (options: Options<SubmitGuardianDetailsData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await submitGuardianDetails({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: submitGuardianDetailsQueryKey(options),
  });
};
 ...
 * Supplies the guardian who will decide on the minor's behalf, and issues that guardian their own consent link. Captures only what is needed to reach them and to record the relationship.
 */
export const submitGuardianDetailsMutation = (
  options?: Partial<Options<SubmitGuardianDetailsData>>
): UseMutationOptions<
  SubmitGuardianDetailsResponse,
  SubmitGuardianDetailsError,
  Options<SubmitGuardianDetailsData>
> => {
  const mutationOptions: UseMutationOptions<
    SubmitGuardianDetailsResponse,
    SubmitGuardianDetailsError,
...
export const uploadClassThumbnailQueryKey = (options: Options<UploadClassThumbnailData>) =>
  createQueryKey('uploadClassThumbnail', options);

/**
 * Upload class thumbnail
 */
export const uploadClassThumbnailOptions = (options: Options<UploadClassThumbnailData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await uploadClassThumbnail({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: uploadClassThumbnailQueryKey(options),
  });
};
 ...
 * Upload class thumbnail
 */
export const uploadClassThumbnailMutation = (
  options?: Partial<Options<UploadClassThumbnailData>>
): UseMutationOptions<
  UploadClassThumbnailResponse,
  UploadClassThumbnailError,
  Options<UploadClassThumbnailData>
> => {
  const mutationOptions: UseMutationOptions<
    UploadClassThumbnailResponse,
    UploadClassThumbnailError,
...
export const addSessionTemplateQueryKey = (options: Options<AddSessionTemplateData>) =>
  createQueryKey('addSessionTemplate', options);

/**
 * Add a session template to an existing class definition
 */
export const addSessionTemplateOptions = (options: Options<AddSessionTemplateData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: addSessionTemplateQueryKey(options),
  });
};
 ...
 * Add a session template to an existing class definition
 */
export const addSessionTemplateMutation = (
  options?: Partial<Options<AddSessionTemplateData>>
): UseMutationOptions<
  AddSessionTemplateResponse,
  AddSessionTemplateError,
  Options<AddSessionTemplateData>
> => {
  const mutationOptions: UseMutationOptions<
    AddSessionTemplateResponse,
    AddSessionTemplateError,
...
export const uploadClassPromotionalVideoQueryKey = (
  options: Options<UploadClassPromotionalVideoData>
) => createQueryKey('uploadClassPromotionalVideo', options);

/**
 * Upload class promotional video
 */
export const uploadClassPromotionalVideoOptions = (
  options: Options<UploadClassPromotionalVideoData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await uploadClassPromotionalVideo({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: uploadClassPromotionalVideoQueryKey(options),
  });
};
 ...
 * Upload class promotional video
 */
export const uploadClassPromotionalVideoMutation = (
  options?: Partial<Options<UploadClassPromotionalVideoData>>
): UseMutationOptions<
  UploadClassPromotionalVideoResponse,
  UploadClassPromotionalVideoError,
  Options<UploadClassPromotionalVideoData>
> => {
  const mutationOptions: UseMutationOptions<
    UploadClassPromotionalVideoResponse,
    UploadClassPromotionalVideoError,
...
export const submitAssignmentQueryQueryKey = (options: Options<SubmitAssignmentQueryData>) =>
  createQueryKey('submitAssignmentQuery', options);

/**
 * Submit assignment
 * Creates a new submission for an assignment by a student.
 */
export const submitAssignmentQueryOptions = (options: Options<SubmitAssignmentQueryData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await submitAssignmentQuery({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: submitAssignmentQueryQueryKey(options),
  });
};
 ...
 * Creates a new submission for an assignment by a student.
 */
export const submitAssignmentQueryMutation = (
  options?: Partial<Options<SubmitAssignmentQueryData>>
): UseMutationOptions<
  SubmitAssignmentQueryResponse,
  SubmitAssignmentQueryError,
  Options<SubmitAssignmentQueryData>
> => {
  const mutationOptions: UseMutationOptions<
    SubmitAssignmentQueryResponse,
    SubmitAssignmentQueryError,
 ...
 */
export const rescheduleScheduledInstanceMutation = (
  options?: Partial<Options<RescheduleScheduledInstanceData>>
): UseMutationOptions<
  RescheduleScheduledInstanceResponse,
  RescheduleScheduledInstanceError,
  Options<RescheduleScheduledInstanceData>
> => {
  const mutationOptions: UseMutationOptions<
    RescheduleScheduledInstanceResponse,
    RescheduleScheduledInstanceError,
  ...
  > = {
    mutationFn: async localOptions => {
      const { data } = await rescheduleScheduledInstance({
        ...options,
        ...localOptions,
        throwOnError: true,
      });
 ...
 */
export const getProgramRatingSummaryOptions = (options: Options<GetProgramRatingSummaryData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getProgramRatingSummary({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getProgramRatingSummaryQueryKey(options),
  });
};
...
export const getCountsQueryKey = (options?: Options<GetCountsData>) =>
  createQueryKey('getCounts', options);

/**
 * Get current user's notification counts
 */
export const getCountsOptions = (options?: Options<GetCountsData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const getInstructorDocumentMediaQueryKey = (
  options: Options<GetInstructorDocumentMediaData>
) => createQueryKey('getInstructorDocumentMedia', options);

/**
 * Get instructor document media
 * Streams an uploaded instructor document by stored relative path.
 */
export const getInstructorDocumentMediaOptions = (
  options: Options<GetInstructorDocumentMediaData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getInstructorDocumentMedia({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getInstructorDocumentMediaQueryKey(options),
  });
};
...
export const getStudentPerformanceQueryKey = (options: Options<GetStudentPerformanceData>) =>
  createQueryKey('getStudentPerformance', options);
...
export const getStudentPerformanceOptions = (options: Options<GetStudentPerformanceData>) => {
  return queryOptions({
    ...
    queryKey: getStudentPerformanceQueryKey(options),
  });
};
...
export const getCourseCreatorDocumentMediaQueryKey = (
  options: Options<GetCourseCreatorDocumentMediaData>
) => createQueryKey('getCourseCreatorDocumentMedia', options);

/**
 * Get course creator document media
 * Streams an uploaded course creator document by stored relative path.
 */
export const getCourseCreatorDocumentMediaOptions = (
  options: Options<GetCourseCreatorDocumentMediaData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getCourseCreatorDocumentMedia({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getCourseCreatorDocumentMediaQueryKey(options),
  });
};
...
export const getClassMediaQueryKey = (options: Options<GetClassMediaData>) =>
  createQueryKey('getClassMedia', options);

/**
 * Get uploaded class media
 */
export const getClassMediaOptions = (options: Options<GetClassMediaData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getClassMedia({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
...
export const getCertificateFileQueryKey = (options: Options<GetCertificateFileData>) =>
  createQueryKey('getCertificateFile', options);
...
export const getCertificateFileOptions = (options: Options<GetCertificateFileData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getCertificateFile({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getCertificateFileQueryKey(options),
  });
};
...
export const getSubmissionMediaQueryKey = (options: Options<GetSubmissionMediaData>) =>
  createQueryKey('getSubmissionMedia', options);
 ...
 */
export const getSubmissionMediaOptions = (options: Options<GetSubmissionMediaData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getSubmissionMedia({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getSubmissionMediaQueryKey(options),
  });
};
