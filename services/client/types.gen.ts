...
export type User = {
   ...
   */
  readonly organisation_affiliations?: Array<UserOrganisationAffiliationDto> | null;
  /**
...
export type Quiz = {
   ...
   */
  readonly source_quiz_uuid?: string | null;
  /**
...
/**
 * A student's answer to a single quiz question
 */
export type QuizResponseSubmission = {
  /**
   * **[REQUIRED]** UUID of the question being answered.
   */
  question_uuid: string;
  /**
   * **[OPTIONAL]** Selected option UUID for multiple-choice or true/false questions.
   */
  selected_option_uuid?: string | null;
  /**
   * **[OPTIONAL]** Free-text answer for short-answer or essay questions.
   */
  text_response?: string | null;
};

export type ApiResponseQuizAttempt = {
  success?: boolean;
  data?: QuizAttempt;
  message?: string;
  error?: unknown;
...
export type QuizAttempt = {
  ...
  status: StatusEnum2;
  /**
   * **[READ-ONLY]** UUID of the instructor who finalised grading of this attempt, when manually graded.
   */
  readonly graded_by?: string;
  /**
   * **[READ-ONLY]** Timestamp when the attempt was graded.
   */
 ...
 */
export type ProgramTrainingApplicationUpdateRequest = {
  /**
...
export type ProgramTrainingApplication = {
   ...
   */
  readonly updated_date?: Date | null;
  /**
...
export type ProgramCourse = {
   ...
   */
  prerequisite_course_uuid?: string | null;
  /**
...
export type Instructor = {
   ...
   */
  readonly admin_verified?: boolean | null;
  /**
...
export type Course = {
   ...
   */
  minimum_training_fee?: number | null;
  /**
   ...
   */
  readonly training_requirements?: Array<CourseTrainingRequirement> | null;
  /**
 ...
 */
export type CourseTrainingApplicationUpdateRequest = {
  /**
   * **[REQUIRED]** Updated rate card across session format and delivery modality combinations.
   */
  rate_card: CourseTrainingRateCard;
...
export type LessonContent = {
   ...
   */
  readonly file_size_bytes?: bigint | null;
  /**
   * **[READ-ONLY]** MIME type of the uploaded file. Automatically detected during upload.
   */
  readonly mime_type?: string;
 ...
 */
export type ClassDefinitionUpdateRequest = {
  /**
   * **[REQUIRED]** Title of the class definition.
   */
  title: string;
  /**
  ...
  description?: string;
  /**
   * **[OPTIONAL]** URL to class thumbnail image.
   */
  thumbnail_url?: string;
  /**
   * **[OPTIONAL]** URL to class promotional video.
   */
  promotional_video_url?: string;
  /**
   * **[REQUIRED]** Default instructor UUID for the class.
   */
  ...
  course_uuid?: string;
  /**
   * **[OPTIONAL]** Program UUID for program-scoped classes.
   */
  program_uuid?: string;
  /**
  ...
  /**
   * **[REQUIRED]** Default start date-time for the class.
   */
  ...
  /**
   * **[OPTIONAL]** Hex color used in calendar UI.
   */
  class_color?: string;
  ...
  meeting_link?: string;
  /**
   * **[OPTIONAL]** Maximum participants.
   */
  max_participants?: number;
  /**
   * **[OPTIONAL]** Whether waitlisting is allowed.
   */
  allow_waitlist?: boolean;
  /**
   * **[OPTIONAL]** Whether the class is active.
   */
  is_active?: boolean;
};
...
export type ClassDefinition = {
  ...
  description?: string | null;
  /**
   * **[OPTIONAL]** URL to class thumbnail image for class listings and previews.
   */
  thumbnail_url?: string | null;
  /**
...
export type ClassSessionTemplate = {
  /**
   * **[READ-ONLY]** Unique identifier for this persisted class session template.
   */
  readonly uuid?: string;
  /**
...
export type Assignment = {
   ...
   */
  readonly source_assignment_uuid?: string | null;
  /**
...
export type AddGroupMembersRequest = {
  /**
   * Student user UUIDs to add.
   */
  student_uuids: Array<string>;
};

export type ApiResponseListStudentGroupMember = {
  success?: boolean;
  data?: Array<StudentGroupMember>;
  message?: string;
  error?: unknown;
};

/**
 * A student's membership within a group.
 */
...
/**
 * Final answers and timing for a quiz attempt being submitted for grading
 */
export type QuizAttemptSubmissionRequest = {
  /**
   * **[OPTIONAL]** Final answers to save before grading. May be omitted if answers were already saved.
   */
  responses?: Array<QuizResponseSubmission>;
  /**
   * **[OPTIONAL]** Time the student spent on the attempt, in minutes. Computed from timestamps when omitted.
   */
  time_taken_minutes?: number | null;
};

/**
 * Instructor grade for a short-answer or essay quiz response
 */
export type QuizManualGradeRequest = {
  /**
   * **[REQUIRED]** Points to award; clamped to the question's maximum.
   */
  points: number;
  /**
   * **[OPTIONAL]** Whether the response is considered correct.
   */
  is_correct?: boolean | null;
  /**
   * **[OPTIONAL]** Feedback for the student on this response.
   */
...
/**
 * Student review and rating for a training program.
 */
export type ProgramReview = {
  ...
  /**
   * **[READ-ONLY]** Training program being reviewed.
   */
  readonly program_uuid?: string;
  /**
   * **[READ-ONLY]** Student who left the review. Null for anonymous public responses.
   */
  readonly student_uuid?: string | null;
  /**
   * **[READ-ONLY]** Timestamp when the review was created.
   */
  readonly created_date?: Date;
  /**
   * **[READ-ONLY]** Created by identifier. Null for anonymous public responses.
   */
  ...
  readonly updated_date?: Date;
  /**
   * **[READ-ONLY]** Updated by identifier. Null for anonymous public responses.
   */
  readonly updated_by?: string | null;
};

/**
 * Payload for submitting or updating a student review for a training program.
 */
export type ProgramReviewRequest = {
  ...
  student_uuid: string;
  /**
   * **[REQUIRED]** Overall rating for the program (1-5).
   */
  rating: number;
  /**
   * Optional short headline for the review.
...
export type ApiResponseProgramReview = {
  success?: boolean;
  data?: ProgramReview;
  message?: string;
  error?: unknown;
...
/**
 * Payload to create an organisation student group.
 */
export type CreateStudentGroupRequest = {
  /**
   * Group name.
   */
  name: string;
...
/**
 * Invites one or more recipients to join an organisation. Supply `recipients`, `student_group_uuids`, or both - at least one must yield somebody to invite.
 */
export type SendOrganisationInvitationsRequest = {
  /**
   * **[OPTIONAL when student_group_uuids is supplied]** People to invite by address.
   */
  recipients?: Array<OrganisationInvitationRecipient>;
  /**
   * **[OPTIONAL]** Organisation student groups to invite. Every member of each group is invited individually, so each person still decides for themselves. Combined with `recipients`, and de-duplicated by email.
   */
  student_group_uuids?: Array<string> | null;
  domain_name: DomainNameEnum;
  /**
...
export type NotificationActionResultDto = {
  action?: string;
  affected_count?: number;
};

export type ApiResponseNotificationDto = {
  success?: boolean;
...
export type CreateCartRequest = {
  ...
  region_code?: string;
  /**
   * Optional collection of line items to pre-populate the cart
   */
...
/**
 * Request payload for creating a class definition and its initial schedule templates
 */
export type ClassDefinitionCreateRequest = {
  /**
   * **[REQUIRED]** Title of the class definition.
   */
  title: string;
  ...
  is_active?: boolean;
  /**
   * **[REQUIRED]** Schedule templates used to generate initial scheduled sessions.
   */
  session_templates: Array<ClassSessionTemplate>;
};

export type ApiResponseClassSessionTemplateScheduleResponse = {
  success?: boolean;
  data?: ClassSessionTemplateScheduleResponse;
  message?: string;
  error?: unknown;
};
...
/**
 * Result of adding a session template to an existing class schedule
 */
export type ClassSessionTemplateScheduleResponse = {
  /**
   * **[READ-ONLY]** Class definition that received the new template.
   */
  class_definition_uuid?: string;
  /**
   * **[READ-ONLY]** Persisted session template.
   */
  session_template?: ClassSessionTemplate;
  /**
   * **[READ-ONLY]** Scheduled instances created from the template.
   */
  scheduled_instances?: Array<ScheduledInstance>;
  /**
   * **[READ-ONLY]** Non-blocking conflicts recorded while applying the template.
   */
  scheduling_conflicts?: Array<ClassSchedulingConflict>;
};

/**
 * Payload for submitting or updating a student review for a class.
 */
export type ClassReviewRequest = {
  /**
   * **[REQUIRED]** Student leaving the review.
   */
  student_uuid: string;
  /**
   * **[REQUIRED]** Overall rating for the class (1-5).
   */
  rating: number;
  /**
   * Optional short headline for the review.
...
export type ApiResponseClassReview = {
  success?: boolean;
  data?: ClassReview;
  message?: string;
  error?: unknown;
...
/**
 * Student review and rating for a class.
 */
export type ClassReview = {
  ...
  readonly uuid?: string;
  /**
   * Overall rating for the class (1-5).
   */
  rating?: number;
  /**
   * Optional short headline for the review.
  ...
  is_anonymous?: boolean;
  /**
   * **[READ-ONLY]** Class definition being reviewed.
   */
...
export type ClassMarketplaceJobApplication = {
   ...
   */
  readonly instructor_admin_verified?: boolean | null;
  /**
...
/**
 * Student assignment submission request
 */
export type AssignmentSubmissionRequest = {
  /**
   * Course enrollment UUID for the student submitting the assignment.
   */
  enrollment_uuid?: string;
  /**
  ...
  student_uuid?: string;
  /**
   * Text content of the student's submission.
   */
  submission_text?: string;
  /**
   * External or previously uploaded file URLs attached to this submission.
   */
  file_urls?: Array<string>;
};
 ...
 */
export type ScheduledInstanceRescheduleRequest = {
  /**
   * **[REQUIRED]** New start date and time for the scheduled instance.
   */
  start_time: Date;
  /**
   * **[REQUIRED]** New end date and time for the scheduled instance.
   */
  end_time: Date;
  /**
...
export type ApiResponseStudentQuiz = {
  success?: boolean;
  data?: StudentQuiz;
  message?: string;
  error?: unknown;
...
/**
 * Student-safe quiz payload without configured answer keys
 */
export type StudentQuiz = {
  ...
  attempts_allowed?: number;
  passing_score?: number;
  questions?: Array<StudentQuizQuestion>;
};

/**
 * Student-safe quiz question payload
 */
export type StudentQuizQuestion = {
  uuid?: string;
  quiz_uuid?: string;
  question_text?: string;
  question_type?: QuestionTypeEnum2;
  points?: number;
  display_order?: number;
  options?: Array<StudentQuizQuestionOption>;
};

/**
 * Student-safe quiz option payload without configured correctness
 */
...
export type ApiResponseStudentQuizReview = {
  success?: boolean;
  data?: StudentQuizReview;
  message?: string;
  error?: unknown;
};

export type OptionReviewDto = {
  uuid?: string;
  question_uuid?: string;
  option_text?: string;
  is_correct?: boolean;
...
export type QuestionReviewDto = {
  ...
  points?: number;
  display_order?: number;
  response?: ResponseReviewDto;
  options?: Array<OptionReviewDto>;
};
...
/**
 * Post-grading student quiz review with submitted answers and correct answers
 */
...
/**
 * Aggregate review metrics for a training program.
 */
export type ProgramRatingSummary = {
  /**
  ...
  /**
   * Total number of reviews for this program.
   */
  review_count?: bigint;
};
...
export type PagedDtoNotificationDto = {
  content?: Array<NotificationDto>;
  metadata?: PageMetadata;
  links?: PageLinks;
};

export type ApiResponseNotificationCountsDto = {
  success?: boolean;
  data?: NotificationCountsDto;
  message?: string;
  error?: unknown;
};
 ...
 */
export type OrgInstructorSummary = {
  /**
   * UUID of the underlying user account.
   */
  user_uuid?: string;
  /**
   * UUID of the instructor profile.
   */
  instructor_uuid?: string;
  /**
  ...
  email?: string | null;
  /**
   * Most recent recorded qualification (level of study). Null when none recorded.
   */
  highest_qualification?: string | null;
  /**
   * Field of study of the most recent qualification. Null when none recorded.
   */
  field_of_study?: string | null;
  /**
   * A representative skill for the instructor. Null when none recorded.
   */
  top_skill?: string | null;
  /**
   * Average review rating (1-5). Null when there are no reviews.
   */
  average_rating?: number | null;
  /**
  ...
  review_count?: bigint;
  /**
   * Number of class definitions this instructor is the default instructor for.
   */
  class_count?: bigint;
};
...
export type ApiResponseListStudentEnrolmentSummaryDto = {
  success?: boolean;
  data?: Array<StudentEnrolmentSummaryDto>;
  message?: string;
  error?: unknown;
};
 ...
 */
export type StudentEnrolmentSummaryDto = {
  /**
   * Student UUID
   */
  student_uuid?: string;
  /**
   * Active enrolments (excludes cancelled/waitlisted)
   */
  total?: bigint;
  /**
   * Enrolments attended
 ...
 */
export type EnrolmentTrendPointDto = {
  /**
   * Calendar month in YYYY-MM form
   */
  month?: string;
  /**
   * Number of enrolments recorded in the month
   */
  total?: bigint;
};

export type ApiResponseListClassEnrolmentCountDto = {
  success?: boolean;
  data?: Array<ClassEnrolmentCountDto>;
  message?: string;
  error?: unknown;
};
 ...
 */
export type ClassEnrolmentCountDto = {
  /**
...
export type DocumentTypeOption = {
  ...
  description?: string;
  /**
   * Maximum allowed file size for this type in MB
   */
...
export type ApiResponsePagedDtoClassReview = {
  success?: boolean;
  data?: PagedDtoClassReview;
  message?: string;
  error?: unknown;
};

export type PagedDtoClassReview = {
  content?: Array<ClassReview>;
  metadata?: PageMetadata;
  links?: PageLinks;
};

export type ApiResponseClassRatingSummary = {
  success?: boolean;
  data?: ClassRatingSummary;
  message?: string;
  error?: unknown;
};

/**
 * Aggregate review metrics for a class.
 */
export type ClassRatingSummary = {
  /**
  ...
  average_rating?: number | null;
  /**
   * Total number of reviews for this class.
   */
  review_count?: bigint;
};
...
export type ApiResponseClassMarketplaceJobEligibility = {
  success?: boolean;
  data?: ClassMarketplaceJobEligibility;
  message?: string;
  error?: unknown;
};

/**
 * Current instructor's eligibility to apply for a marketplace class job
 */
export type ClassMarketplaceJobEligibility = {
  /**
   * Whether the current instructor can apply for this job
   */
  readonly eligible?: boolean;
  /**
   * Human-readable explanation when the instructor is not eligible
   */
...
/**
 * **[REQUIRED]** Delivery location type.
 */
...
export const TypeEnum = {
  ...
  LEARNING_MILESTONE_ACHIEVED: 'LEARNING_MILESTONE_ACHIEVED',
  ASSIGNMENT_DUE_REMINDER: 'ASSIGNMENT_DUE_REMINDER',
  ASSIGNMENT_SUBMITTED_CONFIRMATION: 'ASSIGNMENT_SUBMITTED_CONFIRMATION',
  ...
  NEW_ASSIGNMENT_SUBMISSION: 'NEW_ASSIGNMENT_SUBMISSION',
  CLASS_SCHEDULE_UPDATED: 'CLASS_SCHEDULE_UPDATED',
  GRADING_REMINDER: 'GRADING_REMINDER',
  COURSE_CONTENT_APPROVED: 'COURSE_CONTENT_APPROVED',
  COURSE_CONTENT_REJECTED: 'COURSE_CONTENT_REJECTED',
  PROGRAM_CONTENT_APPROVED: 'PROGRAM_CONTENT_APPROVED',
  PROGRAM_CONTENT_REJECTED: 'PROGRAM_CONTENT_REJECTED',
  COURSE_TRAINING_APPLICATION_SUBMITTED: 'COURSE_TRAINING_APPLICATION_SUBMITTED',
  COURSE_TRAINING_APPLICATION_APPROVED: 'COURSE_TRAINING_APPLICATION_APPROVED',
  COURSE_TRAINING_APPLICATION_REJECTED: 'COURSE_TRAINING_APPLICATION_REJECTED',
  COURSE_TRAINING_APPLICATION_REVOKED: 'COURSE_TRAINING_APPLICATION_REVOKED',
  PROGRAM_TRAINING_APPLICATION_SUBMITTED: 'PROGRAM_TRAINING_APPLICATION_SUBMITTED',
...
export const CategoryEnum = {
  ...
  ASSIGNMENTS_GRADING: 'ASSIGNMENTS_GRADING',
 ...
 * Valid African phone number in international or local format
 */
export type AfricanPhoneNumberWritable = unknown;

/**
 * Valid Kenyan mobile phone number (Safaricom, Airtel formats)
 */
export type KenyanPhoneNumberWritable = unknown;

/**
 * Valid Nigerian mobile phone number (MTN, Glo, Airtel, 9mobile formats)
 */
export type NigerianPhoneNumberWritable = unknown;

/**
 * Valid East African phone number (Kenya, Uganda, Tanzania, Rwanda, Burundi, South Sudan)
 */
export type EastAfricanPhoneNumberWritable = unknown;

/**
 * Valid West African phone number (Nigeria, Ghana, Senegal, Mali, etc.)
 */
export type WestAfricanPhoneNumberWritable = unknown;

/**
 * Valid Southern African phone number (South Africa, Zimbabwe, Zambia, Botswana, etc.)
 */
export type SouthernAfricanPhoneNumberWritable = unknown;

/**
 * Valid international phone number in E.164 format
 */
export type InternationalPhoneNumberWritable = unknown;

/**
 * A valid URL with HTTP or HTTPS protocol
 */
export type ValidUrlWritable = unknown;

/**
 * A valid website URL for personal or business websites
 */
export type WebsiteUrlWritable = unknown;

/**
 * A secure HTTPS URL for API endpoints
 */
export type ApiUrlWritable = unknown;

/**
 * A valid URL pointing to an image file
 */
export type ImageUrlWritable = unknown;

/**
 * A valid URL pointing to a document file
 */
export type DocumentUrlWritable = unknown;

/**
 * A valid social media profile URL
 */
export type SocialMediaUrlWritable = unknown;

export const SchemaEnumWritable = {
  PLATFORM_FEE: 'PLATFORM_FEE',
  AGE_GATE: 'AGE_GATE',
  ENROLLMENT_GUARD: 'ENROLLMENT_GUARD',
  CUSTOM: 'CUSTOM',
...
export type SchemaEnumWritable = (typeof SchemaEnumWritable)[keyof typeof SchemaEnumWritable];

export const SchemaEnum2Writable = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  INACTIVE: 'INACTIVE',
} as const;
 ...
 * **[OPTIONAL]** User's gender information. Used for demographic analytics and personalization. Can be null if not specified or preferred not to disclose.
 */
export const GenderEnumWritable = {
  MALE: 'MALE',
  FEMALE: 'FEMALE',
  OTHER: 'OTHER',
  PREFER_NOT_TO_SAY: 'PREFER_NOT_TO_SAY',
 ...
 * **[OPTIONAL]** User's gender information. Used for demographic analytics and personalization. Can be null if not specified or preferred not to disclose.
 */
export type GenderEnumWritable = (typeof GenderEnumWritable)[keyof typeof GenderEnumWritable];

/**
 * Scope the rule applies to
 */
export const ScopeEnumWritable = {
  GLOBAL: 'GLOBAL',
  TENANT: 'TENANT',
  REGION: 'REGION',
  DEMOGRAPHIC: 'DEMOGRAPHIC',
 ...
 * Scope the rule applies to
 */
export type ScopeEnumWritable = (typeof ScopeEnumWritable)[keyof typeof ScopeEnumWritable];

/**
 * Payload interpretation hint
 */
export const ValueTypeEnumWritable = {
  JSON: 'JSON',
  DECIMAL: 'DECIMAL',
  INTEGER: 'INTEGER',
  BOOLEAN: 'BOOLEAN',
 ...
 * **[REQUIRED]** Rubric publication status in the content workflow.
 */
export const StatusEnumWritable = {
  DRAFT: 'DRAFT',
  IN_REVIEW: 'IN_REVIEW',
  PUBLISHED: 'PUBLISHED',
  ARCHIVED: 'ARCHIVED',
 ...
 * **[REQUIRED]** Rubric publication status in the content workflow.
 */
export type StatusEnumWritable = (typeof StatusEnumWritable)[keyof typeof StatusEnumWritable];

/**
 * **[OPTIONAL]** Unit of measurement for weight calculations.
 */
export const WeightUnitEnumWritable = {
  PERCENTAGE: 'percentage',
  POINTS: 'points',
  RATIO: 'ratio',
} as const;
 ...
 * **[OPTIONAL]** Unit of measurement for weight calculations.
 */
export type WeightUnitEnumWritable =
  (typeof WeightUnitEnumWritable)[keyof typeof WeightUnitEnumWritable];

/**
 * **[OPTIONAL]** Scope of the quiz definition. Course templates act as blueprints, while class clones belong to a single class.
 */
export const ScopeEnum2Writable = {
  COURSE_TEMPLATE: 'COURSE_TEMPLATE',
  CLASS_CLONE: 'CLASS_CLONE',
} as const;
 ...
 * **[OPTIONAL]** Scope of the quiz definition. Course templates act as blueprints, while class clones belong to a single class.
 */
export type ScopeEnum2Writable = (typeof ScopeEnum2Writable)[keyof typeof ScopeEnum2Writable];

/**
 * **[REQUIRED]** Type of question determining the answer format and validation.
 */
export const QuestionTypeEnumWritable = {
  MULTIPLE_CHOICE: 'MULTIPLE_CHOICE',
  TRUE_FALSE: 'TRUE_FALSE',
  SHORT_ANSWER: 'SHORT_ANSWER',
  ESSAY: 'ESSAY',
 ...
 * **[REQUIRED]** Type of question determining the answer format and validation.
 */
export type QuestionTypeEnumWritable =
  (typeof QuestionTypeEnumWritable)[keyof typeof QuestionTypeEnumWritable];

/**
 * **[REQUIRED]** Current status of the quiz attempt.
 */
export const StatusEnum2Writable = {
  IN_PROGRESS: 'IN_PROGRESS',
  SUBMITTED: 'SUBMITTED',
  GRADED: 'GRADED',
} as const;
 ...
 * **[REQUIRED]** Type of requirement classification for this program element.
 */
export const RequirementTypeEnumWritable = {
  STUDENT: 'STUDENT',
  TRAINING_CENTER: 'TRAINING_CENTER',
  INSTRUCTOR: 'INSTRUCTOR',
} as const;
 ...
 * **[REQUIRED]** Type of availability pattern.
 */
export const AvailabilityTypeEnumWritable = {
  DAILY: 'daily',
  WEEKLY: 'weekly',
  MONTHLY: 'monthly',
  CUSTOM: 'custom',
 ...
 * **[REQUIRED]** Type of availability pattern.
 */
export type AvailabilityTypeEnumWritable =
  (typeof AvailabilityTypeEnumWritable)[keyof typeof AvailabilityTypeEnumWritable];

/**
 * **[REQUIRED]** Resource category.
 */
export const RequirementTypeEnum2Writable = {
  MATERIAL: 'material',
  EQUIPMENT: 'equipment',
  FACILITY: 'facility',
  OTHER: 'other',
 ...
 * **[REQUIRED]** Resource category.
 */
export type RequirementTypeEnum2Writable =
  (typeof RequirementTypeEnum2Writable)[keyof typeof RequirementTypeEnum2Writable];

/**
 * **[OPTIONAL]** Party responsible for providing this requirement.
 */
export const ProvidedByEnumWritable = {
  COURSE_CREATOR: 'course_creator',
  INSTRUCTOR: 'instructor',
  ORGANISATION: 'organisation',
  STUDENT: 'student',
 ...
 * **[OPTIONAL]** Party responsible for providing this requirement.
 */
export type ProvidedByEnumWritable =
 ...
 * **[OPTIONAL]** Practice activity format.
 */
export type ActivityTypeEnumWritable =
  (typeof ActivityTypeEnumWritable)[keyof typeof ActivityTypeEnumWritable];

/**
 * **[OPTIONAL]** Student grouping mode for the activity.
 */
export const GroupingEnumWritable = {
  INDIVIDUAL: 'INDIVIDUAL',
  PAIR: 'PAIR',
  SMALL_GROUP: 'SMALL_GROUP',
  WHOLE_CLASS: 'WHOLE_CLASS',
 ...
 * **[OPTIONAL]** Strategy used to aggregate gradebook line items for this assessment component.
 */
export const AggregationStrategyEnumWritable = {
  POINTS_SUM: 'points_sum',
  WEIGHTED_AVERAGE: 'weighted_average',
} as const;
 ...
 * **[REQUIRED]** Class visibility.
 */
export const ClassVisibilityEnumWritable = {
  PUBLIC: 'PUBLIC',
  PRIVATE: 'PRIVATE',
} as const;
 ...
 * **[REQUIRED]** Class visibility.
 */
export type ClassVisibilityEnumWritable =
  (typeof ClassVisibilityEnumWritable)[keyof typeof ClassVisibilityEnumWritable];

/**
 * **[REQUIRED]** Session format.
 */
export const SessionFormatEnumWritable = {
  INDIVIDUAL: 'INDIVIDUAL',
  GROUP: 'GROUP',
} as const;
 ...
 * **[REQUIRED]** Session format.
 */
export type SessionFormatEnumWritable =
  (typeof SessionFormatEnumWritable)[keyof typeof SessionFormatEnumWritable];

/**
 * **[REQUIRED]** Delivery location type.
 */
export const LocationTypeEnumWritable = {
  ONLINE: 'ONLINE',
  IN_PERSON: 'IN_PERSON',
  HYBRID: 'HYBRID',
} as const;
 ...
 * **[REQUIRED]** Delivery location type.
 */
export type LocationTypeEnumWritable =
 ...
 * Recurrence type to apply for the session template
 */
export type RecurrenceTypeEnumWritable =
  (typeof RecurrenceTypeEnumWritable)[keyof typeof RecurrenceTypeEnumWritable];

/**
 * Conflict handling strategy: FAIL (default), SKIP, ROLLOVER
 */
export const ConflictResolutionEnumWritable = {
  FAIL: 'FAIL',
  SKIP: 'SKIP',
  ROLLOVER: 'ROLLOVER',
} as const;
 ...
 * **[REQUIRED]** Type of certificate this template is designed for.
 */
export const TemplateTypeEnumWritable = {
  COURSE_COMPLETION: 'COURSE_COMPLETION',
  PARTICIPATION: 'PARTICIPATION',
  ACHIEVEMENT: 'ACHIEVEMENT',
  CUSTOM: 'CUSTOM',
 ...
 * **[REQUIRED]** Type of certificate this template is designed for.
 */
export type TemplateTypeEnumWritable =
  (typeof TemplateTypeEnumWritable)[keyof typeof TemplateTypeEnumWritable];

/**
 * **[OPTIONAL]** Array of accepted submission types for this assignment.
 */
export const SubmissionTypesEnumWritable = {
  TEXT: 'TEXT',
  DOCUMENT: 'DOCUMENT',
  IMAGE: 'IMAGE',
  AUDIO: 'AUDIO',
 ...
 * **[OPTIONAL]** Array of accepted submission types for this assignment.
 */
export type SubmissionTypesEnumWritable =
  (typeof SubmissionTypesEnumWritable)[keyof typeof SubmissionTypesEnumWritable];

/**
 * **[OPTIONAL]** Current status of the scheduled instance.
 */
export const StatusEnum9Writable = {
  SCHEDULED: 'SCHEDULED',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELLED: 'CANCELLED',
...
export type TypeEnumWritable = (typeof TypeEnumWritable)[keyof typeof TypeEnumWritable];

export const CategoryEnumWritable = {
  LEARNING_PROGRESS: 'LEARNING_PROGRESS',
  ASSIGNMENTS_GRADING: 'ASSIGNMENTS_GRADING',
  COURSE_MANAGEMENT: 'COURSE_MANAGEMENT',
  SOCIAL_LEARNING: 'SOCIAL_LEARNING',
...
export type CategoryEnumWritable = (typeof CategoryEnumWritable)[keyof typeof CategoryEnumWritable];

export const PriorityEnumWritable = {
  LOW: 'LOW',
  NORMAL: 'NORMAL',
  HIGH: 'HIGH',
  CRITICAL: 'CRITICAL',
...
export type PriorityEnumWritable = (typeof PriorityEnumWritable)[keyof typeof PriorityEnumWritable];

export const PresentationEnumWritable = {
  POPUP: 'POPUP',
  INBOX: 'INBOX',
} as const;
 ...
 * How the platform fee was configured
 */
export type ModeEnumWritable = (typeof ModeEnumWritable)[keyof typeof ModeEnumWritable];

/**
 * **[REQUIRED]** Strategy describing how this class schedule derives from the template.
 */
export const ReleaseStrategyEnumWritable = {
  INHERITED: 'INHERITED',
  CUSTOM: 'CUSTOM',
  CLONE: 'CLONE',
} as const;
 ...
 * **[REQUIRED]** Strategy describing how this class schedule derives from the template.
 */
export type ReleaseStrategyEnumWritable =
  (typeof ReleaseStrategyEnumWritable)[keyof typeof ReleaseStrategyEnumWritable];
 ...
 * Payment status reported by the engine
 */
export const PaymentStatusEnumWritable = {
  SUCCEEDED: 'succeeded',
  FAILED: 'failed',
} as const;
 ...
 * Payment status reported by the engine
 */
export type PaymentStatusEnumWritable =
  (typeof PaymentStatusEnumWritable)[keyof typeof PaymentStatusEnumWritable];
 ...
 * Type of assignment - global or organization-specific
 */
export const AssignmentTypeEnumWritable = {
  GLOBAL: 'global',
  ORGANIZATION: 'organization',
} as const;
...
export type SaveQuizResponsesData = {
  body: Array<QuizResponseSubmission>;
  path: {
    quizUuid: string;
    attemptUuid: string;
  };
...
export type SaveQuizResponsesErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type SaveQuizResponsesError = SaveQuizResponsesErrors[keyof SaveQuizResponsesErrors];

export type SaveQuizResponsesResponses = {
  /**
   * OK
   */
  200: ApiResponseQuizAttempt;
};

export type SaveQuizResponsesResponse =
  SaveQuizResponsesResponses[keyof SaveQuizResponsesResponses];
...
export type WithdrawProgramTrainingApplicationErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type WithdrawProgramTrainingApplicationError =
  WithdrawProgramTrainingApplicationErrors[keyof WithdrawProgramTrainingApplicationErrors];

export type WithdrawProgramTrainingApplicationResponses = {
  /**
   * OK
   */
  200: unknown;
...
export type UpdateProgramTrainingApplicationData = {
  body: ProgramTrainingApplicationUpdateRequest;
  path: {
    programUuid: string;
    applicationUuid: string;
  };
...
export type UpdateProgramTrainingApplicationErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type UpdateProgramTrainingApplicationError =
  UpdateProgramTrainingApplicationErrors[keyof UpdateProgramTrainingApplicationErrors];

export type UpdateProgramTrainingApplicationResponses = {
  /**
   * OK
   */
  200: ApiResponseProgramTrainingApplication;
...
export type UpdateProgramTrainingApplicationResponse =
  UpdateProgramTrainingApplicationResponses[keyof UpdateProgramTrainingApplicationResponses];
...
export type WithdrawTrainingApplicationData = {
  body?: never;
  path: {
    courseUuid: string;
    applicationUuid: string;
...
export type WithdrawTrainingApplicationErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type WithdrawTrainingApplicationError =
  WithdrawTrainingApplicationErrors[keyof WithdrawTrainingApplicationErrors];

export type WithdrawTrainingApplicationResponses = {
  /**
   * OK
   */
  200: unknown;
...
export type UpdateTrainingApplicationData = {
  body: CourseTrainingApplicationUpdateRequest;
  path: {
    courseUuid: string;
    applicationUuid: string;
  };
...
export type UpdateTrainingApplicationErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type UpdateTrainingApplicationError =
  UpdateTrainingApplicationErrors[keyof UpdateTrainingApplicationErrors];

export type UpdateTrainingApplicationResponses = {
  /**
   * OK
   */
  200: ApiResponseCourseTrainingApplication;
...
export type UpdateTrainingApplicationResponse =
  UpdateTrainingApplicationResponses[keyof UpdateTrainingApplicationResponses];
...
export type UpdateClassDefinitionData = {
  body: ClassDefinitionUpdateRequest;
  path: {
    /**
...
export type ListRulesData = {
  ...
  path?: never;
  query: {
    category?: SchemaEnumWritable;
    status?: SchemaEnum2Writable;
    pageable: Pageable;
  };
...
export type ListMembersResponses = {
   ...
   * OK
   */
  200: ApiResponseListStudentGroupMember;
};
...
export type StartQuizAttemptData = {
  body?: never;
  path: {
    quizUuid: string;
  };
...
export type StartQuizAttemptErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
  /**
   * No remaining attempts allowed
   */
  409: ApiResponseQuizAttempt;
  /**
   * Internal Server Error
   */
  500: ResponseDtoVoid;
...
export type StartQuizAttemptError = StartQuizAttemptErrors[keyof StartQuizAttemptErrors];

export type StartQuizAttemptResponses = {
  /**
   * Attempt started or resumed
   */
  201: ApiResponseQuizAttempt;
};

export type StartQuizAttemptResponse = StartQuizAttemptResponses[keyof StartQuizAttemptResponses];

export type SubmitQuizAttemptData = {
  body?: QuizAttemptSubmissionRequest;
  path: {
    quizUuid: string;
    attemptUuid: string;
  };
...
export type SubmitQuizAttemptErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type SubmitQuizAttemptError = SubmitQuizAttemptErrors[keyof SubmitQuizAttemptErrors];

export type SubmitQuizAttemptResponses = {
  /**
...
export type SubmitQuizAttemptResponse =
  SubmitQuizAttemptResponses[keyof SubmitQuizAttemptResponses];

export type GradeQuizTextResponseData = {
  body: QuizManualGradeRequest;
  path: {
    quizUuid: string;
    attemptUuid: string;
    questionUuid: string;
...
export type GradeQuizTextResponseErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type GradeQuizTextResponseError =
  GradeQuizTextResponseErrors[keyof GradeQuizTextResponseErrors];

export type GradeQuizTextResponseResponses = {
  /**
   * OK
   */
  200: ApiResponseQuizAttempt;
...
export type GradeQuizTextResponseResponse =
  GradeQuizTextResponseResponses[keyof GradeQuizTextResponseResponses];
...
export type GetProgramReviewsErrors = {
  /**
   * Program not found
   */
  404: unknown;
...
export type GetProgramReviewsError = GetProgramReviewsErrors[keyof GetProgramReviewsErrors];

export type GetProgramReviewsResponses = {
  /**
...
export type GetProgramReviewsResponse =
  GetProgramReviewsResponses[keyof GetProgramReviewsResponses];

export type SubmitProgramReviewData = {
...
export type SubmitProgramReviewErrors = {
  /**
   * Invalid review payload
   */
  400: ApiResponseProgramReview;
  /**
   * Program not found
   */
  404: unknown;
  /**
   * Student is not eligible to review this program
   */
  409: ApiResponseProgramReview;
  /**
   * Internal Server Error
   */
  500: ResponseDtoVoid;
...
export type SubmitProgramReviewError = SubmitProgramReviewErrors[keyof SubmitProgramReviewErrors];

export type SubmitProgramReviewResponses = {
  /**
   * Program review saved successfully
   */
  201: ProgramReview;
};

export type SubmitProgramReviewResponse =
  SubmitProgramReviewResponses[keyof SubmitProgramReviewResponses];
...
export type ListNotificationsResponses = {
   ...
   * OK
   */
  200: ApiResponsePagedDtoNotificationDto;
};

export type ListNotificationsResponse =
  ListNotificationsResponses[keyof ListNotificationsResponses];

export type ApplyBulkActionData = {
  body?: never;
  path?: never;
  query: {
    action: string;
...
export type ApplyBulkActionErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type ApplyBulkActionError = ApplyBulkActionErrors[keyof ApplyBulkActionErrors];

export type ApplyBulkActionResponses = {
  /**
   * OK
   */
  200: ApiResponseNotificationActionResultDto;
};

export type ApplyBulkActionResponse = ApplyBulkActionResponses[keyof ApplyBulkActionResponses];
...
export type ApplyActionResponses = {
   ...
   * OK
   */
  200: ApiResponseNotificationDto;
};
...
export type GetAvailabilitySlotsErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type GetAvailabilitySlotsError =
  GetAvailabilitySlotsErrors[keyof GetAvailabilitySlotsErrors];
...
export type GetAvailabilitySlotsResponse =
  GetAvailabilitySlotsResponses[keyof GetAvailabilitySlotsResponses];
...
export type CreateClassDefinitionMultipartData = {
  body: ClassDefinitionCreateRequest;
  path?: never;
  query: {
    formFields: MultiValueMapStringString;
  };
  url: '/api/v1/classes';
};

export type CreateClassDefinitionMultipartErrors = {
  /**
   * Invalid input data
   */
  400: ApiResponseClassDefinitionResponse;
...
export type CreateClassDefinitionMultipartError =
  CreateClassDefinitionMultipartErrors[keyof CreateClassDefinitionMultipartErrors];

export type CreateClassDefinitionMultipartResponses = {
  /**
...
export type CreateClassDefinitionMultipartResponse =
  CreateClassDefinitionMultipartResponses[keyof CreateClassDefinitionMultipartResponses];

export type UploadClassThumbnailData = {
  body?: {
    /**
     * Thumbnail image file. Supported formats: JPG, PNG, GIF, WebP. Maximum size: 5MB.
     */
    thumbnail: Blob | File;
  };
  path: {
...
export type UploadClassThumbnailErrors = {
  /**
...
export type UploadClassThumbnailError =
  UploadClassThumbnailErrors[keyof UploadClassThumbnailErrors];

export type UploadClassThumbnailResponses = {
  /**
   * Class thumbnail uploaded successfully
   */
  200: ApiResponseClassDefinitionResponse;
};

export type UploadClassThumbnailResponse =
  UploadClassThumbnailResponses[keyof UploadClassThumbnailResponses];

export type AddSessionTemplateData = {
  body: ClassSessionTemplate;
  path: {
    /**
     * UUID of the class definition
     */
...
export type AddSessionTemplateErrors = {
  /**
   * Invalid session template
   */
  400: ApiResponseClassSessionTemplateScheduleResponse;
  /**
   * Class definition not found
   */
  404: ResponseDtoVoid;
   ...
   */
  409: ApiResponseClassSessionTemplateScheduleResponse;
  /**
   * Internal Server Error
   */
  500: ResponseDtoVoid;
...
export type AddSessionTemplateError = AddSessionTemplateErrors[keyof AddSessionTemplateErrors];

export type AddSessionTemplateResponses = {
  /**
   * Class session template applied successfully
   */
  201: ApiResponseClassSessionTemplateScheduleResponse;
};

export type AddSessionTemplateResponse =
  AddSessionTemplateResponses[keyof AddSessionTemplateResponses];

export type GetClassReviewsData = {
  body?: never;
  path: {
    /**
     * UUID of the class definition
...
export type GetClassReviewsErrors = {
  /**
   * Class definition not found
   */
  404: ResponseDtoVoid;
...
export type GetClassReviewsError = GetClassReviewsErrors[keyof GetClassReviewsErrors];

export type GetClassReviewsResponses = {
  /**
   * Class reviews fetched successfully
   */
  200: ApiResponsePagedDtoClassReview;
};

export type GetClassReviewsResponse = GetClassReviewsResponses[keyof GetClassReviewsResponses];

export type SubmitClassReviewData = {
  body: ClassReviewRequest;
  path: {
    /**
     * UUID of the class definition
     */
...
export type SubmitClassReviewErrors = {
  /**
   * Invalid review payload
   */
  400: ApiResponseClassReview;
  /**
   * Class definition not found
   */
  404: ResponseDtoVoid;
  /**
   * Student is not eligible to review this class
   */
  409: ApiResponseClassReview;
  /**
   * Internal Server Error
   */
  500: ResponseDtoVoid;
...
export type SubmitClassReviewError = SubmitClassReviewErrors[keyof SubmitClassReviewErrors];

export type SubmitClassReviewResponses = {
  /**
   * Class review saved successfully
   */
  201: ApiResponseClassReview;
};

export type SubmitClassReviewResponse =
  SubmitClassReviewResponses[keyof SubmitClassReviewResponses];

export type UploadClassPromotionalVideoData = {
  body?: {
    /**
     * Promotional video file. Supported formats: MP4, WebM, MOV, AVI. Maximum size: 100MB.
     */
    promotional_video: Blob | File;
  };
  path: {
    /**
     * UUID of the class definition
...
export type UploadClassPromotionalVideoErrors = {
  /**
   * Invalid promotional video file
   */
  400: ApiResponseClassDefinitionResponse;
  /**
   * Class definition not found
...
export type UploadClassPromotionalVideoError =
  UploadClassPromotionalVideoErrors[keyof UploadClassPromotionalVideoErrors];

export type UploadClassPromotionalVideoResponses = {
  /**
   * Class promotional video uploaded successfully
   */
  200: ApiResponseClassDefinitionResponse;
};

export type UploadClassPromotionalVideoResponse =
  UploadClassPromotionalVideoResponses[keyof UploadClassPromotionalVideoResponses];
...
export type CreateClassDefinitionForProgramMultipartData = {
  body: ClassDefinitionCreateRequest;
  path: {
    /**
     * UUID of the training program
...
export type CreateClassDefinitionForProgramMultipartErrors = {
  /**
   * Invalid input data
   */
  400: ApiResponseClassDefinitionResponse;
...
export type CreateClassDefinitionForProgramMultipartError =
  CreateClassDefinitionForProgramMultipartErrors[keyof CreateClassDefinitionForProgramMultipartErrors];

export type CreateClassDefinitionForProgramMultipartResponses = {
  /**
   * Class definition created successfully
   */
  201: ApiResponseClassDefinitionResponse;
...
export type CreateClassDefinitionForProgramMultipartResponse =
  CreateClassDefinitionForProgramMultipartResponses[keyof CreateClassDefinitionForProgramMultipartResponses];
...
export type SubmitAssignmentQueryData = {
...
export type SubmitAssignmentQueryErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type SubmitAssignmentQueryError =
  SubmitAssignmentQueryErrors[keyof SubmitAssignmentQueryErrors];

export type SubmitAssignmentQueryResponses = {
  /**
   * OK
   */
...
export type SubmitAssignmentQueryResponse =
  SubmitAssignmentQueryResponses[keyof SubmitAssignmentQueryResponses];
...
export type CreateOrganisationUserErrors = {
  /**
   * Email already exists, or the 'student' domain was requested; invite students instead
   */
  400: ApiResponseUser;
  /**
   * Not Found
...
export type RescheduleScheduledInstanceErrors = {
  /**
   * Invalid time range, scheduling conflict, or instance is not reschedulable
   */
  400: ApiResponseScheduledInstance;
  /**
   * Scheduled instance not found
...
export type RescheduleScheduledInstanceError =
  RescheduleScheduledInstanceErrors[keyof RescheduleScheduledInstanceErrors];

export type RescheduleScheduledInstanceResponses = {
  /**
   * Scheduled instance rescheduled successfully
   */
  200: ApiResponseScheduledInstance;
};

export type RescheduleScheduledInstanceResponse =
  RescheduleScheduledInstanceResponses[keyof RescheduleScheduledInstanceResponses];
...
export type GetStudentQuizViewData = {
  body?: never;
  path: {
    quizUuid: string;
  };
...
export type GetStudentQuizViewErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type GetStudentQuizViewError = GetStudentQuizViewErrors[keyof GetStudentQuizViewErrors];

export type GetStudentQuizViewResponses = {
  /**
   * OK
   */
  200: ApiResponseStudentQuiz;
};

export type GetStudentQuizViewResponse =
  GetStudentQuizViewResponses[keyof GetStudentQuizViewResponses];
...
export type GetStudentQuizReviewData = {
  body?: never;
  path: {
    quizUuid: string;
    attemptUuid: string;
...
export type GetStudentQuizReviewErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type GetStudentQuizReviewError =
  GetStudentQuizReviewErrors[keyof GetStudentQuizReviewErrors];

export type GetStudentQuizReviewResponses = {
  /**
   * OK
   */
  200: ApiResponseStudentQuizReview;
};

export type GetStudentQuizReviewResponse =
  GetStudentQuizReviewResponses[keyof GetStudentQuizReviewResponses];
...
export type GetProgramRatingSummaryErrors = {
  /**
   * Program not found
   */
  404: unknown;
...
export type GetProgramRatingSummaryError =
  GetProgramRatingSummaryErrors[keyof GetProgramRatingSummaryErrors];

export type GetProgramRatingSummaryResponses = {
  /**
   * Program rating summary fetched successfully
   */
  200: ProgramRatingSummary;
};

export type GetProgramRatingSummaryResponse =
  GetProgramRatingSummaryResponses[keyof GetProgramRatingSummaryResponses];
...
export type GetCountsResponses = {
   ...
   * OK
   */
  200: ApiResponseNotificationCountsDto;
};
...
export type GetOrganisationInstructorSummariesData = {
  body?: never;
  path: {
    organisationUuid: string;
  };
...
export type GetOrganisationInstructorSummariesError =
  GetOrganisationInstructorSummariesErrors[keyof GetOrganisationInstructorSummariesErrors];

export type GetOrganisationInstructorSummariesResponses = {
  /**
   * Instructor summaries retrieved successfully
   */
  200: ApiResponseListOrgInstructorSummary;
};

export type GetOrganisationInstructorSummariesResponse =
  GetOrganisationInstructorSummariesResponses[keyof GetOrganisationInstructorSummariesResponses];
...
export type GetStudentSummariesError = GetStudentSummariesErrors[keyof GetStudentSummariesErrors];

export type GetStudentSummariesResponses = {
  /**
   * Student enrolment summaries retrieved successfully
   */
  200: ApiResponseListStudentEnrolmentSummaryDto;
};

export type GetStudentSummariesResponse =
  GetStudentSummariesResponses[keyof GetStudentSummariesResponses];

export type GetEnrolmentTrendsData = {
  body?: never;
  path: {
    /**
     * UUID of the organisation to scope the trend to
     */
    organisationUuid: string;
  };
  query?: {
...
export type GetEnrolmentTrendsError = GetEnrolmentTrendsErrors[keyof GetEnrolmentTrendsErrors];

export type GetEnrolmentTrendsResponses = {
  /**
   * Enrolment trends retrieved successfully
   */
  200: ApiResponseListEnrolmentTrendPointDto;
};

export type GetEnrolmentTrendsResponse =
  GetEnrolmentTrendsResponses[keyof GetEnrolmentTrendsResponses];

export type GetClassEnrolmentCountsData = {
  body?: never;
  path: {
    /**
     * UUID of the organisation to scope to
...
export type GetClassEnrolmentCountsError =
  GetClassEnrolmentCountsErrors[keyof GetClassEnrolmentCountsErrors];

export type GetClassEnrolmentCountsResponses = {
  /**
   * Class enrolment counts retrieved successfully
   */
  200: ApiResponseListClassEnrolmentCountDto;
};
...
export type ListDocumentTypesResponses = {
   ...
   * OK
   */
  200: ApiResponseListDocumentTypeOption;
};

export type ListDocumentTypesResponse =
  ListDocumentTypesResponses[keyof ListDocumentTypesResponses];
...
export type GetClassRatingSummaryData = {
  body?: never;
  path: {
    /**
     * UUID of the class definition
...
export type GetClassRatingSummaryErrors = {
  /**
   * Class definition not found
   */
  404: ResponseDtoVoid;
...
export type GetClassRatingSummaryError =
  GetClassRatingSummaryErrors[keyof GetClassRatingSummaryErrors];

export type GetClassRatingSummaryResponses = {
  /**
   * Class rating summary fetched successfully
   */
  200: ApiResponseClassRatingSummary;
};

export type GetClassRatingSummaryResponse =
  GetClassRatingSummaryResponses[keyof GetClassRatingSummaryResponses];
...
export type GetClassMediaData = {
  ...
  path: {
    /**
     * Stored relative path of the class media file.
     */
    filePath: string;
  };
  query?: never;
...
export type GetClassMediaErrors = {
  /**
...
export type GetClassMediaError = GetClassMediaErrors[keyof GetClassMediaErrors];

export type GetClassMediaResponses = {
  /**
   * Class media retrieved successfully
   */
  200: Blob | File;
};

export type GetClassMediaResponse = GetClassMediaResponses[keyof GetClassMediaResponses];

export type GetJobEligibilityData = {
  body?: never;
  path: {
    jobUuid: string;
  };
...
export type GetJobEligibilityErrors = {
  /**
   * Not Found
   */
  404: ResponseDtoVoid;
...
export type GetJobEligibilityError = GetJobEligibilityErrors[keyof GetJobEligibilityErrors];

export type GetJobEligibilityResponses = {
  /**
   * OK
   */
  200: ApiResponseClassMarketplaceJobEligibility;
};
