...
export default function AvailabilityClassCard({
  cls,
  onEnroll,
  onViewCourse,
  onViewClass
  ...
  const { isLoading: lessonsLoading, lessons: lessonsWithContent } =
    useCourseLessonsWithContent({ courseUuid: cls.course_uuid as string });
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                ...
                <span>
                  · {cls.instructor?.data?.full_name ?? ""}
                </span>

                <span>
                  · {cls.level_of_study ?? "Certificate"}
                </span>

                <span>
                  · ⭐ {cls.classRating?.average_rating ?? "0"}
                </span>
              </div>
            </div>
          </div>
        ...
        <CardContent>
          ...
          <div className="grid gap-2 text-xs text-muted-foreground md:grid-cols-3">
            ...
            <div className="inline-flex items-center gap-1.5">
              ...
              {cls.venue ??
                cls.location_name ?? cls?.meeting_link ??
...
export const mockRecommendedClasses = [
  {
    ...
    match: 94,
    why:
      "Matches your preferred language, budget and career goals.",
    breakdown: [
      {
        label: "Career fit",
        score: 20,
  ...
  },
  {
    ...
    match: 87,
    why:
      "Strong match based on your skill interests and availability.",
    breakdown: [
      {
        label: "Career fit",
        score: 18,
