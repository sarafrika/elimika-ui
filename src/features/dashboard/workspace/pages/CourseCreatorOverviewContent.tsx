        ...
        <div className='grid grid-cols-2 gap-4 text-sm'>
          ...
          <div>
            ...
            <p className='text-lg font-semibold whitespace-pre-line'>
              {formatShareRange(
                monetization.creatorShareRange ?? undefined,
                monetization.instructorShareRange ?? undefined
              )}
            </p>
        ...
        <DetailRow
          ...
          value={
            verification.lastUpdated
              ? format(new Date(verification.lastUpdated), 'dd MMM yyyy')
              : '—'
          }
        />
        <DetailRow
          ...
          value={
            verification.createdDate
              ? format(new Date(verification.createdDate), 'dd MMM yyyy')
              : '—'
          }
        />
      </CardContent>
