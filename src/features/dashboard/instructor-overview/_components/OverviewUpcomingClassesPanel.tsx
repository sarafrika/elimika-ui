...
function UpcomingClassRow({ upcomingClass }: { upcomingClass: OverviewUpcomingClass }) {
  return (
    <article className='flex items-start gap-3 border-b border-[#eef0fc] px-2 py-3 last:border-b-0'>
      <PersonAvatar name={upcomingClass.name} />
      <div className='min-w-0 flex-1'>
        <div className='flex items-start justify-between gap-3'>
          <div className='min-w-0'>
            ...
            <p className='truncate text-sm text-slate-500'>{upcomingClass.email}</p>
          </div>
          ...
          <div className='flex flex-col items-end gap-1'>
            ...
            <span className='text-sm text-slate-500'>{upcomingClass.ageLabel}</span>
          </div>
        </div>
      </div>
    </article>
...
export function OverviewUpcomingClassesPanel({
  ...
  return (
    <OverviewSectionShell title='Upcoming Classes' onActionLabel='See All'>
