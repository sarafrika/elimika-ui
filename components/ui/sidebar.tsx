      ...
      <>
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-slot='sidebar'
            data-mobile='true'
            className='bg-sidebar text-sidebar-foreground w-[250px] p-0'
            style={
              {
