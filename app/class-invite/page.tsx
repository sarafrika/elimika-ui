        ...
        <div className="mx-auto w-full max-w-5xl px-6 py-12 lg:py-16">
            {isLoading ? (
                ...
                <Card className="border-border bg-card rounded-[28px] border shadow-xl">
                    ...
                    {/* CTA */}
                    <div className="px-6 border-border flex flex-col gap-3 border-t pt-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="grid grid-cols-7 gap-2">
                    {days.map(date => {
                        ...
                        return (
                            <div
                                key={key}
                                className={`min-h-[90px] rounded-md border p-1 text-xs
                  ${isOutsideMonth ? 'bg-muted/30 text-muted-foreground' : 'bg-card'}
                  ${sessions.length ? 'border-primary/50' : ''}
                `}
                            >
            ...
            <section className='flex flex-row items-center justify-between'>
                <div>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                        <p><strong>Class Limit:</strong> {course.class_limit} students</p>
                        <p><strong>Age Range:</strong> {course.age_lower_limit} – {course.age_upper_limit} years</p>
                    </div>
                </div>
