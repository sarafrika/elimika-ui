...
export default function InviteList({ queryOption }: { queryOption: UseQueryOptions<ApiResponse> }) {
                        ...
                        {invite.inviter_uuid !== user?.uuid && (
                          <>
                            {invite.status === 'PENDING' && (
                              <DropdownMenuItem
                                onClick={() => acceptInvitation(invite.uuid!, invite.token!)}
                              >
                                <Button variant={'ghost'}>
                                  <Check /> <span>Accept</span>
                                </Button>
                              </DropdownMenuItem>
                            )}
                            <DropdownMenuItem
                              onClick={() => declineInvitation(invite.uuid!, invite.token!)}
                            >
                              <Button variant={'ghost'}>
                                <BlocksIcon /> <span>Decline</span>
                              </Button>
                            </DropdownMenuItem>
                          </>
                        )}
