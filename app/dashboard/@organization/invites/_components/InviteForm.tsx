...
import { createBranchInvitation, createOrganizationInvitation } from "../../../../../services/client"
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div className="grid gap-4 my-4">
                            ...
                            <FormField name="recipient_name" control={form.control} render={({ field }) => (
                                <FormItem>
                            ...
                            <FormField name="recipient_email" control={form.control} render={({ field }) => (
                                <FormItem>
                            ...
                            <FormField name="domain_name" control={form.control} render={({ field }) => (
                                <FormItem>
                        ...
                        <DialogFooter>
                            ...
                            <Button type="submit" disabled={form.formState.isSubmitting}>
                                {form.formState.isSubmitting ? <><Loader2 speed={120} /> Inviting...</> : <>Save changes</>}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>
