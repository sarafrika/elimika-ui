...
const OrganisationFundView: React.FC<Props> = ({
    currentUser,
    wallet,
    setWallet,
}) => {
                    ...
                    <div className="space-y-4">
                        {orgContributions.length > 0 ? (
                            orgContributions.map((contrib: any) => (
                                <Card key={contrib.id} className="p-4 bg-muted">
                                    <div className="space-y-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                            ...
                            <p className="text-sm text-purple-700">
                                Sponsoring{' '}
                                {orgContributions.filter((c) => c.targetGroup === 'specific-program').length}{' '}
                                courses
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Textarea
                                ...
                                onChange={(e) =>
                                    setNewContribution({ ...newContribution, purpose: e.target.value })
                                }
                                className="mt-2"
                                rows={4}
                            />
