    ...
    <div className="mx-auto w-full max-w-4xl space-y-8 px-4 py-8">
      <div className="space-y-1">
        <h1 className="text-3xl font-bold tracking-tight">
          Welcome, <span className="text-primary">{session?.user?.name ?? "Organisation Admin"}</span>
        </h1>
        <p className="text-muted-foreground">
          Here&apos;s a quick overview of your <span className="text-primary">organisation&apos;s</span> journey with
          us.
        </p>
      </div>
            ...
            <div className="bg-muted/40 flex flex-col items-center justify-center gap-4 rounded-lg p-8 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground mx-auto max-w-sm">
                  Your organisation&apos;s profile can&apos;t be reviewed until it is complete. Please add your training
                  center details and other required information.
                </p>
              </div>
