  ...
  if (!app) {
    return (
      <div className="mx-auto max-w-md space-y-4 py-16 text-center">
        ...
        <Button asChild><Link href="/dashboard/my-applications">Back to applications</Link></Button>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto w-full max-w-[1400px] space-y-6 px-3 py-4 sm:px-5 lg:px-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Button variant="ghost" size="sm" onClick={() => router.push('/dashboard/my-applications')}>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <ActionButton icon={<RefreshCw className="h-4 w-4" />} title="Reapply" description="Browse the catalogue" onClick={() => router.push('/dashboard/courses/catalog')} />
