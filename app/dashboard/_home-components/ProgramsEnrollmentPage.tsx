...
const ProgramsEnrollmentPage = ({ programId }: { programId: string }) => {
    ...
    if (programId) {
      replaceBreadcrumbs([
        ...
        { id: 'courses', title: 'Browse Courses', url: `/dashboard/all-courses` },
        {
          ...
          url: `/dashboard/all-courses/available-programs/${programId}`,
        },
      ]);
    }
              ...
              {filteredClasses.map(cls => (
                <EnrollCourseCard
                  ...
                  handleEnroll={() => {
                    ...
                    router.push(
                      `/dashboard/all-courses/available-programs/${programId}/enroll?id=${cls?.uuid}`
                    );
                  }}
                  variant='full'
                />
...
export default ProgramsEnrollmentPage;
