            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4'>
              {filteredCourses.map(course => (
                <CourseCard
                  ...
                  isStudentView={true}
                  handleEnroll={() =>
                    router.push(`/dashboard/all-courses/available-classes/${course.uuid}`)
                  }
                  handleSearchInstructor={() =>
                    router.push(`/dashboard/all-courses/instructor?courseId=${course.uuid}`)
                  }
                  handleClick={() => router.push(`/dashboard/all-courses/${course.uuid}`)}
                />
              ))}
            </div>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4'>
              {filteredPrograms.map(program => (
                <CourseCard
                  ...
                  isStudentView={true}
                  handleEnroll={() =>
                    router.push(`/dashboard/all-courses/available-programs/${program.uuid}`)
                  }
                  handleSearchInstructor={() =>
                    router.push(`/dashboard/all-courses/instructor?courseId=${program.uuid}`)
                  }
                  handleClick={() => router.push(`/dashboard/all-courses/${program.uuid}`)}
                />
              ))}
            </div>
