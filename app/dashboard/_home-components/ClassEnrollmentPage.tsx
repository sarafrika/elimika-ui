...
const ClassEnrollmentPage = ({ courseId, classId }: { courseId: string; classId: string }) => {
    ...
    if (courseId && enrollingClass) {
      replaceBreadcrumbs([
        ...
        { id: 'courses', title: 'Browse Courses', url: `/dashboard/all-courses` },
        {
          ...
          url: `/dashboard/all-courses/available-classes/${courseId}`,
        },
        {
          id: 'enroll',
          title: 'Enroll',
          url: `/dashboard/all-courses/available-classes/${courseId}/enroll?id=${classId}`,
        },
      ]);
    }
  }, [replaceBreadcrumbs]);
    ...
    enrollStudent.mutate(
      ...
      },
      {
        onSuccess: data => {
          ...
          router.push(`/dashboard/all-courses/available-classes/${courseId}`);
        },
        onError: err => {
