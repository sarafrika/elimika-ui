      ...
      <div className='mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
        ...
        <div className='flex shrink-0 flex-wrap gap-2'>
          <Button variant='outline' size='sm' asChild>
            <Link href={`/dashboard/admin/instructors/${instructor.user_uuid}`}>
  ...
  return (
    <div className='border-border/60 bg-muted/20 rounded-md border p-4'>
      <div className='mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
        ...
        <div className='flex shrink-0 flex-wrap gap-2'>
          <Button variant='outline' size='sm' asChild>
            <Link href={`/dashboard/admin/course-creators/${creator.user_uuid}`}>
              <ExternalLink className='size-4' />
              Open dossier
            </Link>
          </Button>
      ...
      <div className='flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
        ...
        <div className='flex shrink-0 flex-wrap gap-2'>
          <Button size='sm' asChild>
            <Link href={`/dashboard/admin/manage-courses/${course.uuid}`}>
              <ExternalLink className='size-4' />
              Review course
            </Link>
          </Button>
  ...
  return (
    <div className='border-border/60 bg-muted/20 rounded-md border p-4'>
      <div className='mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
        ...
        <div className='flex shrink-0 flex-wrap gap-2'>
          <Button variant='outline' size='sm' asChild>
            <Link href={`/dashboard/admin/organizations/${organisation.uuid}`}>
              <ExternalLink className='size-4' />
              Open dossier
            </Link>
          </Button>
