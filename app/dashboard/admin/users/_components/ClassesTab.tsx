...
export function ClassesTab({
  ...
  return (
    <SectionCard title='Classes' description='Classes this instructor delivers / has trained in.'>
      <AsyncSection
        ...
        emptyState={
          <p className='text-muted-foreground text-sm'>No classes found for this instructor.</p>
        }
      >
        <div className='space-y-3'>
          {classes.map(klass => (
