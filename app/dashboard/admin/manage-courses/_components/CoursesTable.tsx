...
function CoursesTableView({ courses, isLoading }: { courses: Course[]; isLoading: boolean }) {
  ...
  return (
    <AdminTable
      ...
      onRowClick={course => {
        if (course.uuid) router.push(`/dashboard/admin/manage-courses/${course.uuid}`);
      }}
      facetedFilters={[
        {
          columnId: 'status',
...
function PendingEditsTableView({
          ...
          <Button
            ...
            onClick={e => {
              ...
              if (row.original.course_uuid) {
                router.push(`/dashboard/admin/manage-courses/${row.original.course_uuid}`);
              }
            }}
          >
            Review
  ...
  return (
    <AdminTable
      ...
      onRowClick={edit => {
        if (edit.course_uuid) router.push(`/dashboard/admin/manage-courses/${edit.course_uuid}`);
      }}
      pageSize={12}
