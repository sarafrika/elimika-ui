    ...
    return (
        <div className='min-h-screen'>
            <div className='container mx-auto'>
                <aside className='flex flex-row items-center justify-between max-w-6xl'>
                    ...
                    <Button onClick={() => router.push('/dashboard/courses/create-new-course')}>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
                    {filteredCourses.map(course => (
                        <CourseCard
                            ...
                            handleClick={() => router.push(`/dashboard/courses/${course.uuid}`)} isStudent={false}
                        />
                    ))}
                </div>
