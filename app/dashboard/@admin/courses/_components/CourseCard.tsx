      ...
      <div className='flex items-start justify-between'>
        <div className='min-w-0 flex-1'>
          <div className='mb-1 flex items-center gap-2'>
            <h3 className='truncate text-sm font-medium'>{course.name || 'Course name not provided'}</h3>
          </div>
          <div
            className="text-muted-foreground mb-1 line-clamp-3 lg:line-clamp-0 truncate text-xs w-[95%] lg:w-full"
          >
            <RichTextRenderer
