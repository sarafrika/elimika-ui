...
const dummyOrganizations: OrganisationDto[] = [
    {
        ...
        description: 'A leading provider of professional development and technical training programs across East Africa. We specialize in digital skills, leadership development, and industry-specific certifications.',
    ...
    },
    {
        ...
        description: 'Focused on bridging the skills gap in technology and business through comprehensive training programs and workshops.',
    ...
    },
    {
        ...
        description: 'Delivering high-quality corporate training solutions and professional certification programs for working professionals.',
        domain: 'prolearn.com',
        code: 'PLH003',
    ...
    },
    {
        ...
        description: 'Specializing in cutting-edge technology training including AI, blockchain, and data science for the next generation of tech leaders.',
...
export default async function Page() {
    ...
    // Use dummy data if no organizations are returned from API
    const organizationData = organizations && organizations.length > 0 ? organizations : dummyOrganizations
