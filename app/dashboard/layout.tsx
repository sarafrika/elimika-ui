...
export default async function DashboardLayout(props: DashboardChildrenTypes) {
  try {
    ...
    const userDashboards = Object.keys(props).reduce((a: { [key: string]: ReactNode }, b: string) => (orgAdminDomains.includes(b as OrgDomainType) ? { ...a, [b]: props[b] } : a), {});
