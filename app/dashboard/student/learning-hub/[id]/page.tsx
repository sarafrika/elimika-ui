  ...
  return (
    <div className='flex min-h-[60vh] items-center justify-center px-6'>
      <div className='bg-card w-full max-w-md rounded-xl border p-6 text-center shadow-sm'>
        ...
        <h2 className='text-foreground text-lg font-semibold'>Unable to load class</h2>

        <p className='text-muted-foreground mt-2 text-sm leading-relaxed'>
          We couldn’t retrieve the class information at this time. This may be due to a network
          issue or the class may no longer exist.
        </p>
        ...
        <div className='mt-5 flex items-center justify-center gap-3'>
          ...
          <button
            ...
            className='bg-background text-foreground hover:bg-muted rounded-md border px-4 py-2 text-sm font-medium transition-colors'
          >
            Go back
          </button>
        </div>
