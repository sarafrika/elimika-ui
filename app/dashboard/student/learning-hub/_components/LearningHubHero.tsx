...
export function LearningHubHero({ firstName, stats, loading = false }: LearningHubHeroProps) {
  return (
    <Card className='bg-background relative overflow-hidden p-0 shadow-[0_26px_56px_-48px_rgba(15,23,42,0.2)]'>
      <div className='bg-muted/40 relative min-h-[150px] overflow-hidden rounded-t-md px-4 py-5 sm:px-6 sm:py-6 lg:px-7 lg:py-7'>
        <div className='relative flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between'>
          ...
          <div className='mt-3 flex w-full flex-col gap-2 sm:w-auto lg:mt-0'>
            <Link
              ...
              className='bg-success text-success-foreground inline-flex items-center justify-center gap-2 rounded-[8px] px-4 py-2.5 text-[0.85rem] font-medium transition hover:opacity-95'
            >
