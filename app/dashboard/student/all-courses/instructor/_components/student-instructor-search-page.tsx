...
import { ArrowRight, Bookmark, Plus, Search } from 'lucide-react';
    ...
    replaceBreadcrumbs([
      {
        id: 'dashboard',
        title: 'Dashboard',
        url: buildWorkspaceAliasPath(activeDomain, '/dashboard/student/overview'),
      },
      {
        id: 'courses',
        title: 'Browse Courses',
        url: buildWorkspaceAliasPath(activeDomain, '/dashboard/student/courses'),
      },
      {
        ...
        url: buildWorkspaceAliasPath(
          activeDomain,
          `/dashboard/student/courses/instructor${courseId ? `?courseId=${courseId}` : ''}`
        ),
      },
    ]);
        ...
        <div className='flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between'>
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              <div className='bg-success/10 text-success inline-flex size-8 items-center justify-center rounded-lg'>
                <Search className='size-4' />
              </div>
              <h1 className='text-[clamp(1.45rem,2.6vw,2.3rem)] font-semibold tracking-[-0.03em]'>
                Search Instructors
              </h1>
            </div>
            ...
            <div className='flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between'>
              ...
              <div className='flex flex-col gap-2 sm:flex-row sm:items-center'>
                ...
                <Select value={sortBy} onValueChange={value => setSortBy(value as SortBy)}>
                  <SelectTrigger className='h-10 rounded-xl text-sm sm:w-[180px]'>
