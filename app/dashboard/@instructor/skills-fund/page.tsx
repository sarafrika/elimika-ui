...
const InstructorFundView: React.FC<Props> = ({
    currentUser,
    wallet,
    setWallet,
}) => {
            ...
            <Card className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {trainingOpportunities.map((opp) => (
                        <Card key={opp.id} className="p-4 border-2 hover:border-primary transition-colors">
                            <div className="space-y-3">
                                ...
                                <Button variant="outline" size="sm" className="w-full" onClick={() => setShowApplicationModal(true)}>
                                    Apply
                                </Button>
                            </div>
                        </Card>
                    ...
                    {instructorApplications.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {instructorApplications.map((application) => (
                                <Card key={application.id} className="p-4 bg-muted">
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <p className="text-sm text-green-700">
                                Ready to withdraw or use for expenses
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                            ...
                            <p className="text-sm text-orange-700">
                                Unlocks upon completing each class session
                            </p>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setNewApplication({ ...newApplication, program: e.target.value })
                                }
                                className="mt-2"
                            />
                        </div>
