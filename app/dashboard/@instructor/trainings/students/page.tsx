...
type FilterType = 'all' | 'active' | 'gender';
type Category = 'All' | 'Section A' | 'Section B' | 'Section C';
                    ...
                    >
                      ...
                      <div className='flex-1 overflow-hidden'>
                        ...
                        <p className='text-muted-foreground truncate text-xs'>
                          {enrollment?.length || 0} courses enrolled
                        </p>
                      </div>
        ...
        <div className='fixed inset-0 z-50 lg:hidden'>
          ...
          <div className='animate-slide-in-right bg-background absolute top-0 right-0 bottom-0 w-full shadow-xl'>
            ...
            <div className='flex items-center gap-3 border-b p-4'>
              ...
              <h2 className='flex-1 text-lg font-semibold'>Student Details</h2>
    ...
    <div className='overflow-y-hidden p-6 sm:p-8'>
      ...
      <div className='mb-8 flex items-center gap-4'>
        ...
        <div>
          ...
          <p className='text-muted-foreground text-xs sm:text-sm'>Section A</p>
        </div>
      </div>
