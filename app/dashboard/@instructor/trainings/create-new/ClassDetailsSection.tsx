...
export const ClassDetailsSection = ({
  ...
  useEffect(() => {
    if (!data.class_type || !data.location_type || !selectedCourse?.application?.rate_card) return;
  ...
  return (
    <Card className='overflow-hidden border shadow-sm'>
      ...
      <div className='divide-y'>
        ...
        {/* Course/Subject */}
        <div className='grid grid-cols-3 hover:bg-transparent'>
          <div className='bg-muted/30 px-6 py-4 font-semibold'>Course/Subject *</div>
          <div className='bg-card col-span-2 px-6 py-4'>
            <Select
        ...
        <div className='grid grid-cols-3 hover:bg-transparent'>
          ...
          <div className='bg-card text-muted-foreground col-span-2 grid grid-cols-3 gap-4 px-6 py-4 text-sm'>
            <div>{getDifficultyNameFromUUID(selectedCourse?.difficulty_uuid || '') || '—'}</div>

            <div>{selectedCourse?.class_limit ?? '—'} max participants</div>
        ...
        <div className='grid grid-cols-3 hover:bg-transparent'>
          ...
          <div className='bg-card col-span-2 px-6 py-4'>
            <div className='border-input bg-muted flex h-10 w-full cursor-not-allowed items-center gap-2 rounded-md border px-3 text-sm'>
              <span>{data.rate_card || 'Auto-calculated from course'}</span>
