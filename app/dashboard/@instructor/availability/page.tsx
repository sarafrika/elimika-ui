...
const sampleClassData: ClassData[] = [
    {
            ...
            skills: [
                {
                    ...
                    title: "HTML Basics",
                    lessons: [
                        { id: "lesson-1", title: "Intro to HTML", duration: "30m", date: new Date("2025-10-10"), time: "09:00" },
        ...
        assessments: [
            { id: "assess-1", type: "quiz", title: "HTML Basics Quiz", description: "A short quiz to test your HTML knowledge." }
        ],
        status: "published"
    },

    {
        ...
        description: "Learn Adobe Photoshop from industry experts. Build real-world projects for your portfolio.",
        academicPeriod: {
        ...
        resources: [
            { id: "res-2", type: "file", name: "Design Assets.zip", url: "https://example.com/assets.zip" }
        ],
        assessments: [
            { id: "assess-2", type: "assignment", title: "Portfolio Project", description: "Design a brand poster using learned techniques." }
        ],
        status: "published"
    },

    {
        ...
        description: "This course guides you through the key steps in starting and running a successful business.",
        academicPeriod: {
        ...
        resources: [
            { id: "res-3", type: "link", name: "Business Model Canvas", url: "https://strategyzer.com/canvas/business-model-canvas" }
        ],
        assessments: [
            { id: "assess-3", type: "assignment", title: "Business Plan Draft", description: "Submit your initial business plan for feedback." }
        ],
        status: "draft"
    }
];
...
const Page = () => {
    ...
    const { data: availabilitySlotss, refetch } = useQuery(getInstructorAvailabilityOptions({ path: { instructorUuid: user?.instructor?.uuid as string } }))
