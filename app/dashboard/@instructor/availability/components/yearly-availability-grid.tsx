...
export function YearlyAvailabilityGrid({
    ...
    const getMonthClass = (month: number) => {
        ...
        let baseClasses = "h-32 p-4 border border-gray-200 rounded-lg cursor-pointer transition-all hover:shadow-md relative";
    ...
    const getStatusColor = (count: number, type: 'available' | 'booked' | 'unavailable' | 'reserved') => {
                            ...
                            <Tooltip>
                                    ...
                                    >
                                        <div className="flex flex-col h-full">
                                            <div className="flex items-center justify-between mb-2">
                                                <h4 className="font-medium text-lg">{month.name}</h4>
                                ...
                                <TooltipContent>
                                    <div className="text-sm space-y-1">
                                        <div className="font-medium">{month.name} {currentYear}</div>
