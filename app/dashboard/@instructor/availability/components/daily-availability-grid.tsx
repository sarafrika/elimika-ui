    ...
    <div className='space-y-4'>
      ...
      <div className='overflow-hidden rounded-lg border'>
        <div className='grid grid-cols-2 border-b'>
          ...
          <div className='p-3 text-center'>{currentDate.toLocaleDateString()}</div>
        </div>
        ...
        <div className='max-h-[600px] overflow-y-auto'>
          {timeSlots.map(time => {
            ...
            return (
              <div key={time} className='relative grid grid-cols-2 border-b'>
                <div className='text-muted-foreground flex items-center border-r p-2 text-xs'>
                  {time}
                </div>
                      ...
                      >
                        ...
                        {isAvailabilityStartSlot(weekday, time) &&
                          (() => {
                            ...
                            return (
                              ...
                              >
                                <div className='text-success flex h-full flex-col items-center justify-center text-xs font-medium'>
                                  Available
                        ...
                        {isBlockedStartSlot(weekday, time, currentDate) &&
                          (() => {
                            ...
                            return (
                              ...
                              >
                                <div className='text-destructive flex h-full flex-col items-center justify-center text-xs font-medium'>
                                  Blocked
                        ...
                        {event &&
                          ...
                          event.entry_type !== 'AVAILABILITY' && (
                            <div
                              className='bg-primary/20 border-primary/40 absolute inset-x-1 top-1 z-20 rounded border'
                              style={{
