...
import { blockInstructorTimeMutation, getInstructorAvailabilityOptions } from '@/services/client/@tanstack/react-query.gen';
...
const AvailabilityCalendar = () => {
    ...
    const { data: Iavailability, isLoading } = useQuery(getInstructorAvailabilityOptions({ path: { instructorUuid: instructor?.uuid as string } }))
    ...
    return (
        <div>
            <div className="flex justify-end mb-6">
                <div className="flex flex-row items-center gap-2 self-end">
                    ...
                    <Button
                        ...
                        type="button"
                        className="cursor-pointer px-4 py-2 text-sm bg-red-400"
                        asChild
                    >
                        <div className="flex items-center">
                            <PlusIcon className="mr-1 h-4 w-4" />
            ...
            <AvailabilitySlotDialog
                ...
                onCancel={() => { setOpenSlotModal(false); setSelectedEvent(null) }}
