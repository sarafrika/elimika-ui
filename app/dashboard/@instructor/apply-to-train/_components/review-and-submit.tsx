...
export function ReviewAndSubmit({ data, profile, selectedCourse }: ReviewAndSubmitProps) {
  ...
  const [finalConfirmations, setFinalConfirmations] = useState<string[]>(
  ...
  return (
    <div className='space-y-6'>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div className='flex flex-col'>
              ...
              {status.incompleteItems.length > 0 && (
                <ul className='mt-3 list-disc space-y-1 pl-4 text-sm text-yellow-700'>
      ...
      <Card>
        ...
        <CardContent className='space-y-6'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground text-sm'>
                        {data?.organizationType || 'Organization Type'} •{' '}
          ...
          <div className='bg-red-100'>
            ...
            <div className='bg-muted/20 space-y-3 rounded-lg p-4'>
              ...
              {data?.availableDates && data.availableDates.length > 0 && (
                <div>
                  <span className='text-muted-foreground text-sm'>Available Dates:</span>
          ...
          <div className='bg-red-100'>
            ...
            <div className='bg-muted/20 space-y-2 rounded-lg p-4 text-sm'>
            ...
            <div className='bg-muted/20 rounded-lg p-4'>
              <div className='grid grid-cols-2 gap-4 text-sm'>
                <div>
                  ...
                  <p>
                    {data?.uploadedDocs ? Object.values(data.uploadedDocs).flat().length : 0} files
                  </p>
                </div>
                <div>
                  <span className='text-muted-foreground'>Compliance Agreements:</span>
                  <p>{data?.complianceAgreements?.length || 0} of 4 completed</p>
                </div>
              </div>
              {data?.gdprCompliant && (
              ...
              <div className='space-y-4 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium capitalize'>
                    {data?.trainingMode || 'Not specified'}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span>Status:</span>
            ...
            <div key={confirmation.id} className='flex items-start space-x-3'>
              <Checkbox
                ...
                onCheckedChange={checked =>
                  handleConfirmationChange(confirmation.id, checked as boolean)
                }
                className='mt-1'
              />
              <Label htmlFor={confirmation.id} className='cursor-pointer text-sm leading-relaxed'>
                {confirmation.text}
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Next Steps:</strong> After submission, your application will be reviewed by our
          team. You will receive a confirmation email and updates on the review status. The review
