...
export function ResourcesAndRequirements({ data, onDataChange }: ResourcesAndRequirementsProps) {
    ...
    const handleSoftwareToggle = (software: any) => {
        ...
        const newSelection = isSelected ? selectedSoftware.filter(s => s.name !== software.name) : [...selectedSoftware, software];
                                        ...
                                        >
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-xs text-muted-foreground mt-1">{software.description}</p>
                                                </div>
                                                <div className="flex items-center gap-2">
