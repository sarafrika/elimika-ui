...
import { createAssignmentMutation, getAllAssessmentRubricsOptions, getAllAssignmentsQueryKey, updateAssignmentMutation } from '@/services/client/@tanstack/react-query.gen';
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                ...
                                <FormControl>
                                    <input
                                        type="datetime-local"
                                        className="w-full text-sm border border-gray-300 rounded-md px-3 py-[7px] focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function AssignmentDialog({ isOpen, setOpen, editingAssignmetId, initialValues, lessonId, onSuccess, onCancel }: AssignmentDialogProps) {
    return (
        <Dialog open={isOpen} onOpenChange={setOpen}>
            <DialogContent className='flex max-w-6xl flex-col p-0'>
                <DialogHeader className='border-b px-6 py-4'>
                    <DialogTitle className='text-xl'>{editingAssignmetId ? "Edit Assignment" : "Add Assignment"}</DialogTitle>
