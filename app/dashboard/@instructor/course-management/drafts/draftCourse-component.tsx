...
import { EyeIcon, FilePenIcon, MoreVertical, PenIcon, PlusIcon, Square, TrashIcon } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';
import { useEffect, useState } from 'react';
import { toast } from 'sonner';

export default function DraftCoursesComponent({ instructorId }: { instructorId: string }) {
    ...
    const { data, isFetched } = useQuery(
        searchCoursesOptions({
            query: {
                searchParams: { status: 'draft', instructor_uuid_eq: instructorId },
                pageable: { page, size },
            },
        })
    );
