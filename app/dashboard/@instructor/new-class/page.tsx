        ...
        <Card className='border-border/70 bg-card shadow-sm'>
            <CardHeader className='space-y-4 pb-4'>
                <div className='flex items-start justify-between gap-3'>
                    ...
                    {classes.length > QUERY_HINT_FILTERS_AT ? (
            ...
            <CardContent className='space-y-2.5'>
                {isLoading ? (
                    Array.from({ length: 8 }).map((_, index) => (
                        <Skeleton key={index} className='h-[88px] rounded-[24px]' />
                    ))
                ) : classes.length === 0 ? (
                    <div className='border-border/70 rounded-[24px] border border-dashed p-6 text-center'>
                        <p className='text-foreground font-medium'>No active classes yet</p>
                        <p className='text-muted-foreground mt-1 text-sm'>
                                    ...
                                    <div className='flex items-start justify-between gap-3'>
                                        <div className='min-w-0'>
                                            ...
                                            <p className='text-muted-foreground mt-0.5 text-[11px]'>
                                                {classItem.sessionFormat || 'Lecture'} • {classItem.difficulty}
                                            </p>
                                        </div>
                                        <BrandPill className='px-3 py-1 text-[10px] normal-case tracking-normal'>
                                    ...
                                    <div className='grid grid-cols-2 gap-2 text-[11px]'>
                                        <div>
                                            ...
                                            <p className='text-foreground mt-1 font-medium'>
                                                {classItem.scheduleCount}
                                            </p>
                                        </div>
                                        <div>
                                            <p className='text-muted-foreground'>Remaining</p>
                                            <p className='text-foreground mt-1 font-medium'>
                                                {classItem.remainingSessions}
                                            </p>
                                        </div>
                                    </div>
                                </div>
