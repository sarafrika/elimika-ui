...
export default function InstructorClassPage() {
  ...
  const { classes: classData, loading, isPending } = useAmdinClassesWithDetails();
      ...
      {isPending ? (
        ...
        <Card className='bg-background flex h-[calc(75vh-2rem)] flex-col overflow-hidden pt-0 font-sans sm:h-[calc(82vh-2rem)] md:h-[calc(80vh-2rem)]'>
          ...
          <div className='relative flex flex-1 overflow-hidden'>
            ...
            <div
              className={`${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} bg-background border-border fixed z-40 flex h-full w-60 flex-col overflow-y-hidden border-r transition-transform duration-300 ease-in-out md:w-64 lg:relative lg:translate-x-0`}
            >
              <div className='border-border border-b p-3 md:p-4'>
                <div className='relative'>
