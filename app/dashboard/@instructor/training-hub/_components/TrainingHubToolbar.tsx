    ...
    >
      <div className='flex flex-col gap-3 min-[900px]:gap-2 min-[900px]:flex-row min-[900px]:items-center'>
        ...
        <div className='flex flex-wrap gap-2 min-[900px]:justify-end'>
          <label className='relative inline-flex h-11 items-center rounded-[10px] border border-border/60 bg-background px-3 pr-9 text-[0.88rem] font-medium text-foreground transition hover:border-primary/30 focus-within:ring-2 focus-within:ring-primary/20 sm:px-4 sm:text-[0.92rem]'>
            <select
