...
const AssignmentSubmissionPage = () => {
    ...
    const { data, isLoading, isFetched } = useQuery(getAssignmentSubmissionsOptions({ path: { assignmentUuid: assignmentId as string } }))
    ...
    return (
        <div className='space-y-6'>
            ...
            {isFetched && submissions.length > 0 && <div className="overflow-hidden rounded-lg border border-gray-200">
                <Table>
