    ...
    rateCards: [
        {
            ...
            description: 'Comprehensive React training covering hooks, context, performance optimization, and testing.',
            hourlyRate: 150,
            halfDayRate: 550,
            fullDayRate: 1000,
            features: [
            ...
            packages: [
                ...
                },
                {
                    ...
                    duration: '10 days',
                    price: 8500,
                    features: ['Everything in Professional', 'Team mentoring', 'Code review', 'Custom projects']
                }
            ],
            status: 'published',
        ...
        },
        {
            ...
            description: 'Complete introduction to data science using Python, covering data analysis, visualization, and machine learning basics.',
            hourlyRate: 120,
            halfDayRate: 450,
            fullDayRate: 800,
            features: [
        ...
        },
        {
            ...
            category: 'Design',
            description: 'Hands-on design workshop covering user research, wireframing, prototyping, and design systems.',
            hourlyRate: 100,
            halfDayRate: 380,
            fullDayRate: 700,
            features: [
...
export function InstructorRateCard() {
                                ...
                                <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setEditingCard({ ...editingCard, hourlyRate: Number(e.target.value) })}
                                                />
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setEditingCard({ ...editingCard, halfDayRate: Number(e.target.value) })}
                                                />
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setEditingCard({ ...editingCard, fullDayRate: Number(e.target.value) })}
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    <Alert>
                                        ...
                                        <AlertDescription>
                                            ...
                                            Half-day and full-day rates often offer better value for extended training sessions.
                                        </AlertDescription>
                                    </Alert>
                                </CardContent>
                            </Card>
                                        ...
                                        {editingCard.features?.map((feature: string, index: number) => (
                                            <div key={index} className="flex gap-2">
                                                ...
                                                <Button
                                                    ...
                                                    size="icon"
                                                    onClick={() => {
                                                        const newFeatures = editingCard.features.filter((_: any, i: number) => i !== index);
                                                        setEditingCard({ ...editingCard, features: newFeatures });
                                                    }}
                                                >
                                            ...
                                            <div key={index} className="grid grid-cols-2 gap-2">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        size="icon"
                                                        onClick={() => {
                                                            const newExtras = editingCard.extras.filter((_: any, i: number) => i !== index);
                                                            setEditingCard({ ...editingCard, extras: newExtras });
                                                        }}
                                                    >
                                                        <Trash2 className="w-4 h-4" />
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">{editingCard.category || 'Category'}</p>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{formatCurrency(editingCard.hourlyRate || 0)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm">Half Day (4hrs)</span>
                                            <span className="font-medium">{formatCurrency(editingCard.halfDayRate || 0)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm">Full Day (8hrs)</span>
                                            <span className="font-medium">{formatCurrency(editingCard.fullDayRate || 0)}</span>
                                        </div>
                                    </div>
                                    ...
                                    {editingCard.features && editingCard.features.length > 0 && (
                                        <div>
                                            ...
                                            <ul className="space-y-1">
                                                {editingCard.features.filter((f: string) => f.trim()).map((feature: string, index: number) => (
                                    ...
                                    {editingCard.extras && editingCard.extras.length > 0 && (
                                        <div>
                                            <h4 className="text-sm font-medium mb-2">Optional Extras:</h4>
                                            <ul className="space-y-1">
                                                {editingCard.extras.filter((e: any) => e.name.trim()).map((extra: any, index: number) => (
    ...
    return (
        <div className="min-h-screen">
            <div className='bg-red-500 w-fit'> Needs endpoint to fetch courses instructor can train</div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-600">{formatCurrency(instructor.totalRevenue)}</p>
                                </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-primary">{instructor.activeRates}</p>
                                </div>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b">
                                                ...
                                                <th className="text-left p-4">Hr/Rate (1 hr)</th>
                                                <th className="text-left p-4">Half Day Rate (4 hrs)</th>
                                                <th className="text-left p-4">Day Rate (8 hrs)</th>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {rateCards.filter(card => card.revenue > 0).map(card => (
                                            <div key={card.id} className="flex justify-between items-center">
                                                <div>
                                                    <p className="font-medium">{card.title}</p>
                                                    <p className="text-sm text-muted-foreground">{card.bookings} bookings</p>
                                                </div>
                                                <div className="text-right">
                                                    <p className="font-bold">{formatCurrency(card.revenue)}</p>
                                                    <p className="text-sm text-muted-foreground">★ {card.avgRating}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">
                                                {formatCurrency(Math.round(rateCards.reduce((sum, card) => sum + card.hourlyRate, 0) / rateCards.length))}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Display market rate comparisons
                                        </p>
                                    </div>
                                    <Switch />
                                </div>
