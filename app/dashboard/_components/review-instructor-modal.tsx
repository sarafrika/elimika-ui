            ...
            <DialogContent>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        ...
                        <RatingField label="Engagement" value={engagementRating} onChange={onEngagementRatingChange} />
                        <RatingField label="Punctuality" value={punctualityRating} onChange={onPunctualityRatingChange} />
                    </div>
                </div>
