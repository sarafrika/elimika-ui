...
import {
    BookOpen,
    Calendar,
    Clock, EyeIcon, LucideFileWarning, MapPin, MoreVertical, PenIcon, Search,
    SlidersHorizontal,
    Users
} from 'lucide-react';
                            ...
                            <div className="relative h-full bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 rounded-2xl p-[2px] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
                                <div className="h-full bg-white rounded-2xl overflow-hidden">
                                    ...
                                    <div className="relative h-48 overflow-hidden">
                                        ...
                                        <Image
                                            src={cls?.course?.thumbnail_url as string || "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=600&fit=crop"}
                                            alt={cls?.title}
                                        ...
                                        <div className="absolute top-3 left-3 z-20 flex flex-wrap gap-2">
                                            <Badge className={`${getLocationBadgeColor(cls?.location_type)} backdrop-blur-sm`}>
                                        ...
                                        <div className="absolute top-3 right-3 z-30">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem
                                                        onClick={() => router.push(`/dashboard/trainings/create-new?id=${cls.uuid}`)}
                                                    ...
                                                    <DropdownMenuItem
                                                        onClick={() => openTimetableSchedule(cls.uuid)}
                                                        className="flex w-full items-center cursor-pointer"
                                                    >
                                                    ...
                                                    <DropdownMenuItem
                                                        onClick={() => openRecurrentSchedule(cls.uuid)}
                                                        className="flex w-full items-center cursor-pointer"
                                                    >
                                                        <Calendar className="mr-2 h-4 w-4" />
                                                        Schedule Recurring
                                                    ...
                                                    <DropdownMenuSeparator />
                                                    <DropdownMenuItem
                                                        onClick={() => openDeleteModal(cls.uuid)}
                                    ...
                                    <div className="p-5 space-y-4">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {cls?.course?.category_names?.slice(0, 2).map((category: any, idx: any) => (
                                                <Badge key={idx} variant="outline" className="text-xs bg-blue-50/50 text-blue-700 border-blue-200/50">
                                                    {category}
                                                </Badge>
                                            ))}
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3 pt-2 border-t border-blue-100/50">
                                            ...
                                            <div className="flex items-center gap-2 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm">{cls?.current_enrollments || "N?A"}/{cls?.max_participants}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between pt-2 border-t border-blue-100/50">
                                            ...
                                            <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                                                ...
                                                <span>Starts {new Date(cls?.start_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })} {cls?.default_start_time} </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
