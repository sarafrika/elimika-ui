...
export const BookingDetailsModal: React.FC<BookingDetailsModalProps> = ({ booking, instructors, open, onClose }) => {
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl">
                <DialogHeader className="flex flex-col gap-2">
                    ...
                    <span
                        className={`px-2 w-fit py-1 text-xs text-white rounded capitalize ${getStatusColor(
                            booking?.status
                        )}`}
                    >
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="capitalize">
                                    {booking.payment_engine?.replace('-', ' ')}
                                </span>
                            </div>
                            <div className="flex justify-between text-sm">
