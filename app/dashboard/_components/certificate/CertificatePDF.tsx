...
const TYPE_COPY: Record<CertificateType, { headline: string; awardLine: string }> = {
  diploma: {
    headline: 'DIPLOMA',
    awardLine: 'has completed all requirements for graduation and is hereby awarded this',
  },
  degree: {
    headline: 'DEGREE',
    awardLine: 'has fulfilled all requirements and is hereby conferred the degree of',
  },
  certificate: {
    headline: 'CERTIFICATE',
    awardLine: 'has successfully met all requirements and is hereby awarded this',
  },
  'certificate-of-completion': {
    headline: 'CERTIFICATE OF COMPLETION',
    awardLine: 'has successfully completed the course requirements for',
  },
  'certificate-of-achievement': {
    headline: 'CERTIFICATE OF ACHIEVEMENT',
    awardLine: 'is hereby recognized for outstanding achievement in',
  },
};
    ...
    <Document>
      <Page size={[PAGE_WIDTH, PAGE_HEIGHT]} style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.date}>Date of Completion: {data.completionDate}</Text>
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.signatureBlock}>
            ...
            <Text style={styles.signature}>{data.signatoryName || 'Authorized Signatory'}</Text>
            <Text style={styles.signatureTitle}>{data.signatoryTitle || ''}</Text>
          </View>

          <View style={styles.signatureBlock}>
            <Text style={styles.signatureLine}>____________________</Text>
            <Text style={styles.signature}>{data.secondSignatoryName || ''}</Text>
            <Text style={styles.signatureTitle}>{data.secondSignatoryTitle || ''}</Text>
          </View>
        </View>
