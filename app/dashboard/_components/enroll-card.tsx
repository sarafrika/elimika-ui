...
import { createCartMutation, enrollStudentMutation, getInstructorByUuidOptions, getStudentScheduleQueryKey } from "../../../services/client/@tanstack/react-query.gen";

const stripHtml = (html: string) => html.replace(/<[^>]+>/g, '');

export const EnrollmentCards = ({ classData, course, onViewClass }: { classData: any; course: any, onViewClass: (classData: any) => void }) => {
    const {
        title,
        description,
