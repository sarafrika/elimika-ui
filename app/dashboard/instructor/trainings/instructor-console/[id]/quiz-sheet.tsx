      ...
      <div className='flex items-start gap-3 p-4'>
        ...
        <div className='min-w-0 flex-1'>
          <div className='mb-2 flex flex-wrap items-center gap-2'>
            <span
              className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${typeStyle}`}
            >
    ...
    <div className='space-y-5'>
      <div className='flex justify-end'>
        <Button variant='outline' size='sm'>
          <Link
            href={`/dashboard/instructor/assessment/quiz/${quizUuid}/grade`}
        ...
        <div className='flex h-full flex-col'>
          ...
          <div className='border-b px-6 py-5'>
            <SheetHeader>
              ...
              <SheetDescription>
                All quizzes scheduled for this class — view questions, settings, and remove as
                needed.
              </SheetDescription>
            </SheetHeader>
          </div>
            ...
            {!mergedQuizzes?.length ? (
              <div className='flex h-full flex-col items-center justify-center py-20 text-center'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Add quizzes from a session's action menu.
                </p>
              </div>
            ) : (
                      ...
                      <CardContent className='p-5'>
                              ...
                              {(item.attempt_limit_override ?? quiz.attempts_allowed) && (
                                <div className='flex items-center gap-1.5'>
                                  ...
                                  <span className='text-muted-foreground'>
                                    ...
                                    {(item.attempt_limit_override ?? quiz.attempts_allowed) !== 1
                                      ? 's'
                                      : ''}
                                  </span>
                                </div>
                        ...
                        {isExpanded && (
                          <div className='border-border/50 mt-5 border-t pt-5'>
                            <QuizDetailPanel quizUuid={quiz.uuid} scheduleItem={item} />
                          </div>
                        )}
                      </CardContent>
                    </Card>
          ...
          <div className='border-t px-6 py-4'>
            <div className='flex items-center justify-between'>
              <span className='text-muted-foreground text-sm'>
                {mergedQuizzes?.length ?? 0} quiz{mergedQuizzes?.length !== 1 ? 'zes' : ''}{' '}
                scheduled
              </span>
