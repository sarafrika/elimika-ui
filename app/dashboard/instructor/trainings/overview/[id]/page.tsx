...
export default function ClassPreviewPage() {
  ...
  useEffect(() => {
    ...
    replaceBreadcrumbs([
      { id: 'dashboard', title: 'Dashboard', url: '/dashboard/instructor/overview' },
      {
        ...
        url: '/dashboard/instructor/trainings',
      },
      {
        id: 'preview-training',
        title: 'Preview',
        url: `/dashboard/instructor/trainings/overview/${classId}`,
        isLast: true,
      },
    ]);
  ...
  return (
    <div className='mb-20 space-y-6'>
      ...
      <div>
        {classData?.is_active ? (
          <Card className='border-success/30 bg-success/10 py-0'>
          ...
          <Card className='border-warning/40 bg-warning/10 py-0'>
            <CardContent className='flex items-center gap-2 px-3 py-2'>
              <svg
