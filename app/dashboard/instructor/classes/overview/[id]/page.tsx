  ...
  useEffect(() => {
    ...
    replaceBreadcrumbs([
      { id: 'dashboard', title: 'Dashboard', url: '/dashboard/instructor/overview' },
      {
        id: 'trainings',
        title: 'Classes',
        url: '/dashboard/instructor/classes',
      },
      {
        id: 'preview-training',
        title: 'Preview',
        url: `/dashboard/instructor/classes/overview/${classId}`,
        isLast: true,
      },
    ]);
  ...
  return (
    <div className='my-8 mb-20 space-y-6 px-2 sm:px-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <Button
          onClick={() => router.push(`/dashboard/instructor/classes/new?id=${classData?.uuid}`)}
          variant='outline'
          className='gap-2'
        >
