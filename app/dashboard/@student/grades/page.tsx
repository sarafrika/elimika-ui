    ...
    <div className='min-h-screen'>
      ...
      <div className='flex items-center justify-self-end'>
        <div className='text-right'>
          ...
          <p className='text-muted-foreground text-xs'>ID: {studentData?.uuid}</p>
        </div>
      </div>
      ...
      <div className='container mx-auto py-8'>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className='mt-4 mb-2 grid w-full grid-cols-3'>
                        ...
                        <div key={assignment.id} className='space-y-3 rounded-lg border p-4'>
                          <div className='flex items-start justify-between'>
                            <div className='flex items-start gap-3'>
                              <AssignmentIcon className='text-primary mt-1 h-5 w-5' />
                              <div>
                            ...
                            <div className='text-right'>
                              {assignment.earnedPoints !== null ? (
                                <>
                                  <div className='flex items-center gap-2'>
                                    <span
                                      className={`font-bold ${getGradeColor((assignment.earnedPoints / assignment.maxPoints) * 100)}`}
                                    >
                                ...
                                <Badge
                                  className={getStatusColor(isOverdue ? 'overdue' : 'pending')}
                                >
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='text-lg font-bold'>
                        {Math.round(
                          courses.reduce((sum, c) => sum + c.overallGrade, 0) / courses.length
                        )}
                        %
                      </span>
                    </div>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='font-bold'>
                        {courses.reduce(
                          (sum, c) => sum + c.assignments.filter(a => a.status === 'graded').length,
                          0
                        )}
                    ...
                    <div key={course.id} className='rounded-lg border p-4'>
                      ...
                      <div className='grid grid-cols-2 gap-4 md:grid-cols-4'>
                        <div className='text-center'>
                          <p className='text-primary text-2xl font-bold'>{course.overallGrade}%</p>
                        ...
                        <div className='text-center'>
                          <p className='text-2xl font-bold'>
                            {course.assignments.filter(a => a.status === 'graded').length}
                          </p>
