...
import { getAvailabilityForDateOptions, getInstructorAvailabilityOptions } from '@/services/client/@tanstack/react-query.gen';
        ...
        <div className="space-y-6">
            ...
            <Card className="p-6 space-y-3">
                    ...
                    <RadioGroup value={mode} onValueChange={(v: any) => setMode(v)} className="mt-2">
                        {instructor.is_profile_complete && (
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="mode-online" className="cursor-pointer flex items-center gap-2">
                        ...
                        {instructor.is_profile_complete && (
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="mode-onsite" className="cursor-pointer flex items-center gap-2">
                ...
                <div className="space-y-4">
                    ...
                    {recurring && (
                        <div className="space-y-4 pl-6 border-l-2 border-border mb-6">
                            <div>
