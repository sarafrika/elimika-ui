...
import { InstructorProfileModal } from './instructor-profile-modal';
...
export const InstructorDirectory: React.FC<Props> = ({
    ...
    const filteredInstructors = instructors?.filter((instructor) => {
        ...
        if (
            ...
            instructor.type !== filters.instructorType
        ) {
            return false;
        }
        ...
        if (
            ...
            !filters.specializations.some((spec) =>
                instructor.specializations.includes(spec)
            )
        ) {
            return false;
        }
                ...
                <div className="w-80 flex-shrink-0 space-y-4">
                    <Card className="p-4 space-y-6">
                        <div className="flex items-center justify-between">
                            <h3 onClick={() => {
                                // at screens below 1440px, collapse the filter box, use a hamburger to represent it
                                // when I click the hamburger, let the filter box show, but have a z-index to cover, such that I can edit the filters and collapse it
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <Slider
                                    ...
                                    className="flex-1"
                                />
                                <span className="text-sm w-8">{filters.minRating.toFixed(1)}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-2 space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <label htmlFor="mode-online" className="text-sm cursor-pointer">
                                        Online
                                    </label>
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <label htmlFor="mode-onsite" className="text-sm cursor-pointer">
                                        Onsite
                                    </label>
                                </div>
                            </div>
                            ...
                            {filters.instructorType !== 'all' && (
                                <Badge variant="secondary" className="gap-1">
                                    ...
                                    <X
                                        className="w-3 h-3 cursor-pointer"
                                        onClick={() =>
                                            setFilters({ ...filters, instructorType: 'all' })
                                        }
                                    />
                                </Badge>
                            )}
