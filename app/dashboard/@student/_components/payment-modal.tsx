  ...
  return (
    <Card className='space-y-6 p-6'>
      ...
      <div>
        ...
        <h3>Payment</h3>
        <p className='text-muted-foreground mt-1 text-sm'>Choose your payment method</p>
      </div>
      ...
      <div>
        ...
        >
          ...
          <div className='flex items-center space-x-2'>
            ...
            <Label htmlFor='payment-card' className='flex flex-1 cursor-pointer items-center gap-2'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            <Label htmlFor='payment-bank' className='flex flex-1 cursor-pointer items-center gap-2'>
      ...
      {/* Security Note */}
      <div className='text-muted-foreground bg-muted flex items-start gap-2 rounded-lg p-3 text-xs'>
        <Lock className='mt-0.5 h-3 w-3' />
        <p>
          Your payment information is secure and encrypted. We do not store your card details on our
          servers.
        </p>
      </div>
    </Card>
