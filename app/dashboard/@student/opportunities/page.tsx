...
import { Briefcase, GraduationCap, Trophy, UserPlus, Users, Wrench } from 'lucide-react';
...
type TabKey = 'jobs' | 'apprenticeships' | 'attachment' | 'scholarships' | 'competitions' | 'clubs';
