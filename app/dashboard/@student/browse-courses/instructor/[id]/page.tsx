...
const InstructorBookingDashboard: React.FC<Props> = ({
    classes,
}) => {
    const bookings = exampleBookings || []
    const [instructors, setInstructors] = useState<Instructor[]>([]);
    const [activeTab, setActiveTab] = useState('browse');
    const { data } = useQuery(getAllInstructorsOptions({ query: { pageable: { page: 0, size: 20 } } }));
            ...
            const sampleInstructors: Instructor[] = [
                {
                    ...
                    profileImage: 'https://images.unsplash.com/photo-1594256347468-5cd43df8fbaf?w=400&h=400&fit=crop&crop=face',
                    type: 'individual',
                    gender: 'female',
                    rating: 4.9,
                    totalReviews: 127,
                    ...
                    availability: [
                        { id: 'slot-1', date: new Date(2024, 9, 16), startTime: '09:00', endTime: '11:00', status: 'available' },
                        { id: 'slot-2', date: new Date(2024, 9, 16), startTime: '14:00', endTime: '16:00', status: 'available' },
                        { id: 'slot-3', date: new Date(2024, 9, 17), startTime: '10:00', endTime: '12:00', status: 'available' },
                        { id: 'slot-4', date: new Date(2024, 9, 18), startTime: '09:00', endTime: '11:00', status: 'available' },
                    ],
                    rateCard: {
                        hourly: 50,
                        halfDay: 180,
                    ...
                    reviews: [
                        {
                            ...
                            rating: 5,
                            comment: 'Excellent instructor! Very patient and knowledgeable. Helped me land my first job.',
                ...
                },
                {
                    ...
                    availability: [
                        { id: 'slot-5', date: new Date(2024, 9, 16), startTime: '13:00', endTime: '15:00', status: 'available' },
                        { id: 'slot-6', date: new Date(2024, 9, 17), startTime: '09:00', endTime: '11:00', status: 'available' },
                        { id: 'slot-7', date: new Date(2024, 9, 19), startTime: '10:00', endTime: '12:00', status: 'available' },
                    ],
                    rateCard: {
                        hourly: 75,
                        halfDay: 270,
                ...
                },
                {
                    ...
                    certifications: [
                        { id: 'cert-5', name: 'Google UX Design Professional Certificate', issuer: 'Google', year: 2021 },
                        { id: 'cert-6', name: 'Interaction Design Foundation', issuer: 'IDF', year: 2019 },
                    ],
                    availability: [
                        { id: 'slot-8', date: new Date(2024, 9, 16), startTime: '10:00', endTime: '12:00', status: 'available' },
                        { id: 'slot-9', date: new Date(2024, 9, 16), startTime: '15:00', endTime: '17:00', status: 'available' },
                        { id: 'slot-10', date: new Date(2024, 9, 18), startTime: '09:00', endTime: '11:00', status: 'available' },
                        { id: 'slot-11', date: new Date(2024, 9, 19), startTime: '14:00', endTime: '16:00', status: 'available' },
                    ],
                    rateCard: {
                        hourly: 60,
                        halfDay: 220,
                    ...
                    reviews: [
                        {
                            ...
                            rating: 5,
                            comment: 'Amazing mentor! Helped me build a portfolio that landed me multiple interviews.',
                ...
                },
                {
                    ...
                    profileImage: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=400&h=400&fit=crop&crop=faces',
                    type: 'organization',
                    rating: 4.7,
                    totalReviews: 245,
                    totalStudents: 2500,
                    experience: 15,
                    specializations: ['Corporate Training', 'Full Stack Development', 'Cloud Computing', 'DevOps'],
                    ...
                    availability: [
                        { id: 'slot-12', date: new Date(2024, 9, 16), startTime: '09:00', endTime: '17:00', status: 'available' },
                        { id: 'slot-13', date: new Date(2024, 9, 17), startTime: '09:00', endTime: '17:00', status: 'available' },
                        { id: 'slot-14', date: new Date(2024, 9, 18), startTime: '09:00', endTime: '17:00', status: 'available' },
                    ],
                    rateCard: {
                        hourly: 100,
                        halfDay: 350,
                    ...
                    reviews: [
                        {
                            ...
                            rating: 5,
                            comment: 'Excellent training program for our development team. Very professional and thorough.',
