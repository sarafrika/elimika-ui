        ...
        <div className="p-2 sm:p-4 md:p-6 space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-3 text-sm">
                    ...
                    <p>
                        <span className="font-medium">Final Grade:</span> {data.final_grade} ({data.grade_letter})
                    </p>
                    <p>
                    ...
                    {data.revoked_at !== null ? (
                        <>
                            ...
                            <p className="text-gray-500 mt-2">
                                Certificate link and download are disabled.
                            </p>
                        </>
                    ) : (
                        <>
                ...
                <div>
                    {data.revoked_at !== null ? (
                        <div className="text-center text-red-500 p-4 border rounded shadow bg-red-50">
                            Certificate preview is unavailable because this certificate has been revoked.
                        </div>
                    ) : data.certificate_url ? (
                        <div className="border rounded overflow-hidden shadow-md h-[500px]">
                            <iframe
