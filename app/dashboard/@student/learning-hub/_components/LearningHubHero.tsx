...
const statToneClasses = {
  blue:
    'bg-[linear-gradient(135deg,color-mix(in_srgb,var(--primary)_88%,black_8%),color-mix(in_srgb,var(--primary)_72%,white_22%))]',
  green:
    'bg-[linear-gradient(135deg,color-mix(in_srgb,var(--success)_78%,black_12%),color-mix(in_srgb,var(--success)_58%,white_28%))]',
  red:
    'bg-[linear-gradient(135deg,color-mix(in_srgb,var(--destructive)_82%,black_6%),color-mix(in_srgb,var(--destructive)_70%,white_20%))]',
  orange:
