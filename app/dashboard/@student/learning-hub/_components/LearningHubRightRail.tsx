...
export function LearningHubRightRail({ recommendedCourses }: LearningHubRightRailProps) {
  return (
      ...
      <Card className='rounded-[18px] border border-border/70 bg-background p-3 shadow-[0_20px_45px_-40px_rgba(15,23,42,0.18)]'>
        ...
        <div className='mt-3 space-y-3'>
          {recommendedCourses.map(course => (
            <div key={course.id} className='flex items-start gap-3 rounded-[10px] border border-border/50 p-2.5'>
        ...
        <Link
          prefetch
          href='/dashboard/all-courses'
          className='mt-4 inline-flex w-full items-center justify-center gap-1 rounded-[8px] border border-border/70 bg-background px-4 py-2 text-[0.78rem] font-medium text-muted-foreground transition hover:text-primary'
        >
          See All 28
