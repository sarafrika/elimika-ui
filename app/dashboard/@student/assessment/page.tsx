...
export default function AssessmentPage() {
  ...
  const assignments = allAssessments.filter(a => a.type === 'assignment' || a.type === 'project');
  ...
  const renderAssessmentCard = (assessment: any) => {
    ...
    const isOverdue =
      assessment.dueDate && new Date(assessment.dueDate) < new Date() && !assessment.submittedDate;
    ...
    return (
      <Card
        key={`${assessment.courseCode}-${assessment.id}`}
          ...
          <div className='flex items-start justify-between'>
            <div className='flex flex-1 items-start gap-3'>
              ...
              <div className='flex-1'>
                <CardTitle className='mb-1 text-base'>{assessment.title}</CardTitle>
        ...
        <CardContent className='space-y-4'>
          ...
          {assessment.feedback && (
            <div className='bg-muted/50 rounded-md p-3'>
              <p className='text-sm'>
                <strong className='text-muted-foreground'>Feedback:</strong> {assessment.feedback}
              </p>
            </div>
          )}
    ...
    <div className='container'>
      <div className='flex flex-col gap-6 md:flex-row'>
        ...
        <div className='border-border rounded-md border md:w-64'>
          <div className='flex gap-2 overflow-x-auto p-4 md:flex-col md:overflow-visible'>
