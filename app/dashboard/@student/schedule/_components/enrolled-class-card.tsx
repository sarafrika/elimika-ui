...
const EnrolledClassCard = ({
  ...
  return (
    <Card className='pt-0 group flex h-full flex-col overflow-hidden transition-all hover:shadow-lg'>
      ...
      <CardHeader className='space-y-2 pb-3'>
        ...
        {classData?.subtitle && (
          <p className='text-muted-foreground line-clamp-2 text-sm'>{classData.subtitle}</p>
        )}
      </CardHeader>
