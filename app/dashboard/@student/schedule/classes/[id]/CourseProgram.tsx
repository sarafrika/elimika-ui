                        ...
                        {lessons.map((module, moduleIndex) => {
                            ...
                            return (
                                <Collapsible
                                    ...
                                    open={isOpen}
                                    onOpenChange={() =>
                                        onToggleModule(module.lesson.uuid)
                                    }
                                >
                                    <Card className="border-2 py-2.5">
                                        <CollapsibleTrigger asChild>
                                            <CardHeader className="cursor-pointer px-3 py-2 transition-colors hover:bg-muted sm:px-6">
                                            ...
                                            <CardContent className="px-3 pt-0 sm:px-6">
                                                <div className="space-y-2">
                                                    {module.content.data.map((content) => {
                                                        ...
                                                        const isCompleted =
                                                            completedLessons.has(content.uuid);
                                                        const isLocked =
                                                            lockedLessons.has(content.uuid);
