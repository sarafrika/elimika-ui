...
export function ReadingMode({
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                <Card className="max-w-md p-8 text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        No content to display in reading mode.
                    </p>
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
            <Card
                ref={containerRef}
                className="absolute inset-2 flex flex-col shadow-2xl"
            >
                {/* Header */}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="hidden sm:flex items-center gap-1 bg-muted/50 rounded-lg p-1">
                                ...
                                <button
                                    ...
                                    className="px-2 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors min-w-[3rem]"
                                >
                                    {zoomLevel}%
                                </button>
                ...
                <div className="border-t bg-muted/30 px-4 py-2 flex items-center justify-between">
                    ...
                    <div className="flex sm:hidden items-center gap-1 bg-muted rounded-lg p-1">
                        ...
                        <span className="px-2 text-xs font-medium min-w-[2.5rem] text-center">
                            {zoomLevel}%
                        </span>
