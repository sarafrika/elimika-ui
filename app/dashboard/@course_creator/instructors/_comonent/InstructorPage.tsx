...
const InstructorsApplicationPage = () => {
    ...
    const stats = useMemo(() => {
        return {
            ...
            instructors: filteredApplications.filter(a => a.applicant_type?.toLowerCase() === 'instructor')
                .length,
        };
        ...
        <div className={elimikaDesignSystem.components.pageContainer}>
            ...
            <main className="flex gap-6">
                ...
                <aside className="w-80 flex-shrink-0">
                    <Card className="p-4">
                        <h2 className="text-lg font-semibold mb-4">All Instructors</h2>
                        <div className="space-y-3 max-h-[calc(100vh-250px)] overflow-y-auto">
                            {isLoadingInstructors ? (
                                ...
                                [...Array(3)].map((_, i) => (
                                    <div
                                        key={i}
                                        className="p-4 rounded-xl border border-border bg-muted/30 animate-pulse"
                                    >
                                ...
                                instructors.map((instructorItem) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full text-left p-4 rounded-xl border transition-all duration-150 flex items-start gap-4 shadow-sm ${selectedInstructorUuid === instructorItem.uuid
                ...
                <div className="flex-1">
                    {!selectedInstructorUuid ? (
                        ...
                        <div>
                            <div className="flex gap-6 mb-6 border-b border-muted-foreground/10">
                                <button
                                    onClick={() => setTabs("profile")}
                                    className={`text-[15px] pb-2 px-2 font-medium transition-colors ${tabs === "profile"
                                ...
                                <button
                                    ...
                                    className={`text-[15px] pb-2 px-2 font-medium transition-colors ${tabs === "application"
                                        ? "border-b-2 border-primary text-primary font-extrabold"
                                        : "text-muted-foreground hover:text-foreground"
                                        }`}
                                >
