...
const SAMPLE_NOTIFICATIONS: Notification[] = [
    {
        ...
        message: 'Sarah Johnson has applied to teach "Advanced React Development". Review their credentials and experience.',
    ...
    },
    {
        ...
        message: 'Hi! I have a question about the assignment for Week 3. Could you clarify the requirements?',
    ...
    },
    {
        ...
        actions: [
            { label: 'View Class', type: 'view', variant: 'default' }
        ],
    ...
    },
    {
        ...
        actions: [
            { label: 'View Details', type: 'view', variant: 'outline' }
        ],
    ...
    },
    {
        ...
        message: 'Your "JavaScript Essentials" class on Thursday has been moved to Friday 3:00 PM due to student request.',
        ...
        actions: [
            { label: 'View Schedule', type: 'view', variant: 'default' }
        ],
    ...
    },
    {
        ...
        actions: [
            { label: 'View Review', type: 'view', variant: 'outline' }
        ],
    ...
    },
    {
        ...
        actions: [
            { label: 'Join Class', type: 'view', variant: 'default' }
        ],
    ...
    },
    {
        ...
        message: 'Congratulations! You\'ve successfully taught 50 classes and received an average rating of 4.8 stars.',
        timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3), // 3 days ago
        status: 'read',
        priority: 'low',
        actions: [
            { label: 'View Stats', type: 'view', variant: 'outline' }
        ],
    ...
    },
    {
        ...
        message: 'New features available: Live polling during classes and automated attendance tracking. Check them out!',
        timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5), // 5 days ago
        status: 'read',
        priority: 'low',
        actions: [
            { label: 'Learn More', type: 'view', variant: 'outline' }
        ],
    ...
    },
    {
        ...
        message: 'Alumni student requesting access to "Advanced TypeScript" course materials for review purposes.',
...
const getPriorityBadgeVariant = (priority: NotificationPriority) => {
    const variantMap: Record<NotificationPriority, 'default' | 'destructive' | 'outline' | 'secondary'> = {
        low: 'outline',
        medium: 'secondary',
        high: 'default',
        urgent: 'destructive'
...
const NotificationsPage = () => {
    ...
    const messageCount = notifications.filter(n => n.type === 'message' && n.status === 'unread').length;
    const requestCount = notifications.filter(n => n.type === 'request' && n.status === 'unread').length;
        ...
        <div className={elimikaDesignSystem.components.pageContainer}>
            ...
            <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 rounded-md shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <p className="text-sm text-yellow-900">Mock data is currently being displayed on this page.</p>
                </div>
            </div>
