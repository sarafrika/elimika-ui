            ...
            {lessons?.content?.map((lesson: any) => (
              <div
                ...
                className={cn(
                  ...
                  lesson.uuid === activeLessonId ? 'border-muted/80 bg-muted/50 border' : ''
                )}
              >
                <div
                  onClick={() => {
                ...
                <div
                  ...
                  className='text-destructive hover:text-destructive/90 absolute top-1/2 right-2 -translate-y-1/2 cursor-pointer opacity-0 transition-opacity group-hover:opacity-100'
                >
                  <Trash2 size={16} />
                </div>
              </div>
      ...
      <main className='w-3/4 space-y-6 overflow-y-auto pb-20'>
            ...
            <Form {...form}>
              <div className='space-y-4'>
                ...
                <div className='flex justify-end'>
                  <Button type='button' onClick={saveLesson} disabled={addLessonMutation.isPending}>
        ...
        <div className='px-2'>
          ...
          <CardContent className='space-y-4'>
            {!activeLessonId ? (
              <div className='text-muted-foreground border-muted-foreground bg-muted/50 rounded border p-6 text-center'>
                  ...
                  {(enrichedLessonContentsMap.get(activeLessonId) || []).map(
                    (content: any, idx: number) => (
                      <div
                        ...
                        className={cn(
                          'flex w-full cursor-pointer flex-row items-center justify-between rounded-sm px-3 py-2 text-left',
                      ...
                      >
                        <div className='flex-1' onClick={() => handleEditContent(content)}>
                          <span className='pr-2 italic'>{idx + 1}.</span>
                            ...
                            <div className='flex flex-col gap-4'>
                              ...
                              >
                                ...
                                <div
                                  ...
                                  className='bg-muted/40 cursor-pointer rounded-md border px-6 py-8 text-center'
                                >
                                  {mediaFile
                                    ? mediaFile.name
