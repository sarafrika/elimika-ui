                                    ...
                                    <tr key={row.id} className='hover:bg-muted/20 transition-colors'>
                                        ...
                                        <td className='px-3 py-2'>
                                            <Textarea
                                                ...
                                                value={row.name}
                                                onChange={e => updateDraftRow(activeProvider, row.id, { name: e.target.value })}
                                        ...
                                        <td className='px-3 py-2'>
                                            <Select
                                                ...
                                                onValueChange={v => updateDraftRow(activeProvider, row.id, { requirement_type: v })}
                                            >
                                        ...
                                        <td className='px-3 py-2'>
                                            <Input
                                                ...
                                                placeholder='0'
                                                value={row.quantity}
                                                onChange={e => updateDraftRow(activeProvider, row.id, { quantity: e.target.value })}
                                                className='h-8 w-20'
                                            />
                                        </td>
                                        ...
                                        <td className='px-3 py-2 text-center'>
                                            <Checkbox
                                                ...
                                                onCheckedChange={v => updateDraftRow(activeProvider, row.id, { is_mandatory: !!v })}
                                            />
                                        </td>
                                        ...
                                        <td className='px-3 py-2'>
                                            <Textarea
                                                ...
                                                onChange={e => updateDraftRow(activeProvider, row.id, { description: e.target.value })}
                                ...
                                <div className='border-border overflow-hidden rounded-lg border'>
                                    <table className='w-full text-sm'>
                                        <thead className='bg-muted/60 border-border border-b'>
                                            <tr>
                                                {['Requirement Name', 'Type', 'Quantity', 'Unit', 'Mandatory', 'Description', ''].map(h => (
                                                    <th
                                                        key={h}
                                                        className='text-muted-foreground px-3 py-2 text-left text-xs font-medium tracking-wide whitespace-nowrap'
                                                    >
                                        ...
                                        <tbody className='divide-border divide-y'>
                                            {group.rows.map(req => {
                                                ...
                                                return (
                                                    <tr key={req.uuid} className={isEditing ? 'bg-muted/30' : 'hover:bg-muted/20 transition-colors'}>
                                                        {/* Name */}
                                                        <td className='px-3 py-2'>
                                                            {isEditing ? (
                                                                <Input
                                                        ...
                                                        <td className='px-3 py-2'>
                                                            {isEditing ? (
                                                                <Select
                                                                    ...
                                                                    onValueChange={v => setEditDraft(p => ({ ...p, requirement_type: v }))}
                                                                >
                                                                    <SelectTrigger className='h-8 min-w-[110px]'>
                                                                        <SelectValue />
                                                                    </SelectTrigger>
                                                                ...
                                                                <span className='text-muted-foreground capitalize'>{req.requirement_type}</span>
                                                            )}
                                                        </td>
                                                        ...
                                                        <td className='px-3 py-2 text-center'>
                                                            {isEditing ? (
                                                                <Checkbox
                                                                    ...
                                                                    onCheckedChange={v => setEditDraft(p => ({ ...p, is_mandatory: !!v }))}
                                                                />
                                                            ) : req.is_mandatory ? (
                                                        ...
                                                        <td className='px-3 py-2 max-w-[200px]'>
                                                            {isEditing ? (
                                                                ...
                                                                <span className='text-muted-foreground line-clamp-2 text-xs'>{req.description || '—'}</span>
                                                            )}
                                                        </td>
                ...
                {grouped.length > 0 && (
                    <div className="border-border overflow-hidden rounded-lg border">
                        <table className="w-full text-sm">
                            ...
                            <tbody className="items-start divide-border divide-y">
                                ...
                                {grouped.map(group => (
                                    <Fragment key={group.value}>
                                        ...
                                        <tr className="bg-muted/40">
                                            <td
                                                colSpan={7}
                                                className="text-foreground px-3 py-2 text-xs font-bold uppercase tracking-wide"
                                            >
                                                {group.label}
                                            </td>
                                        </tr>
                                        ...
                                        {group.rows.map(req => {
                                            ...
                                            const isDeleting = deletingId === req.uuid;
                                            const isSavingEdit =
                                                updateTrainingReqMut.isPending && isEditing;
