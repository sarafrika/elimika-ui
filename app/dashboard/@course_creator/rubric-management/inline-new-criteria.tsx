...
import { RubricCriteriaFormValues, rubricCriteriaSchema } from '../_components/rubric-management-form';
            ...
            <Form {...form}>
                ...
                >
                        ...
                        render={({ field }) => (
                            <FormItem className="flex items-start space-x-3">
                                ...
                                <div className="space-y-1 leading-none">
                                    ...
                                    <FormDescription>
                                        Marks this as a primary assessment component.
                                    </FormDescription>
                                </div>
                            </FormItem>
                        )}
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <Button
                            type="submit"
                            disabled={createCriteria.isPending || updateCriteria.isPending}
                        >
                            {editingCriteria
