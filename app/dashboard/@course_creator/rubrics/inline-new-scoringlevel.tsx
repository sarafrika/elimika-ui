...
export default function InlineNewScoringLevel({ rubricId, onClose, defaultValues }: Props) {
  const [editingLevel, setEditingLevel] = useState<ScoringLevel | null>(defaultValues ?? null);
  ...
  const handleSubmit = (values: ScoringLevelFormValues) => {
    ...
    if (editingLevel?.uuid) {
      ...
      createLevel.mutate({ path: { rubricUuid: rubricId }, body: payload as any }, { onSuccess });
    }
  };
  ...
  return (
    <div className='mx-2 rounded-lg border'>
      <div className='border-b px-6 py-4'>
        <h2 className='text-xl font-semibold'>Add New Scoring Level</h2>
      ...
      <Form {...form}>
        <form
          ...
          className='flex max-w-2xl flex-col gap-6 p-4 pb-6'
        >
          {/* Passing */}
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex items-start space-x-3'>
                ...
                <div className='leading-none'>
                  ...
                  <FormDescription>Marks this scoring level as passing.</FormDescription>
                </div>
              </FormItem>
            )}
          />
          ...
          <div className='flex justify-end gap-2'>
            ...
            <Button type='submit' disabled={createLevel.isPending || updateLevel.isPending}>
              {editingLevel
