      ...
      <div className='bg-card overflow-hidden rounded-xl border'>
        <div className='grid gap-4 p-4 sm:grid-cols-[260px_1fr] sm:p-6'>
          {image && !imgError ? (
            ...
            <div className='from-primary/15 to-primary/5 flex h-44 w-full items-center justify-center rounded-lg bg-gradient-to-br sm:h-full'>
              ...
              {rating != null && (
                <span className='flex items-center gap-1'>
                  ...
                  <span className='text-muted-foreground'>
                    ({content?.total_reviews ?? 0} reviews)
                  </span>
                </span>
              )}
              ...
              <div className='space-y-2'>
                {lessons.map((lesson: OrgLesson) => (
                  <div
                    ...
                    className='bg-muted/30 flex items-start justify-between gap-3 rounded-lg border px-3 py-2.5'
                  >
