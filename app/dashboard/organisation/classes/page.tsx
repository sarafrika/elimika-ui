...
export default function ClassesPage() {
  ...
  const createButton = (
    <Button asChild className="gap-1.5">
      <Link href="/dashboard/organisation/classes/new"><Plus className="h-4 w-4" /><span className="hidden sm:inline">Create class</span><span className="sm:hidden">Create</span></Link>
    </Button>
  );
    ...
    <div className="mx-auto w-full max-w-[1600px] space-y-6 px-3 py-4 sm:px-5 lg:px-6 2xl:max-w-[1840px]">
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-dashed p-12 text-center">
          ...
          <Button asChild className="mt-4 gap-1.5"><Link href="/dashboard/organisation/classes/new"><Plus className="h-4 w-4" /> Create class</Link></Button>
        </div>
      ) : (
                      ...
                      <TableCell className="whitespace-nowrap text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => router.push('/dashboard/organisation/calendar')}><Eye className="mr-2 h-4 w-4" /> View schedule</DropdownMenuItem>
                            <DropdownMenuItem onClick={() => router.push('/dashboard/organisation/students')}><Users className="mr-2 h-4 w-4" /> Manage enrolment</DropdownMenuItem>
                            <DropdownMenuItem onClick={() => router.push('/dashboard/organisation/notifications')}><Send className="mr-2 h-4 w-4" /> Message class</DropdownMenuItem>
                            {r.status === 'Active' && (
                              <>
                                <DropdownMenuSeparator />
