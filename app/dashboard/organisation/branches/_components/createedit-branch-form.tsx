...
export default function CreateEditBranchform({
  ...
  async function onSubmit(branchData: BranchType) {
    ...
    if (!branch)
      ...
      createResp = await updateTrainingBranch({
    ...
    redirect(`/dashboard/organisation/branches/${newBranch.uuid}`);
  }
        ...
        <Card className='max-w-[80%]'>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    <LocationInput
                      {...(field as unknown as ComponentProps<typeof LocationInput>)}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
          ...
          <CardFooter className='flex flex-row-reverse gap-3'>
            ...
            <Button type='button' variant={'ghost'}>
              <Link href={'/dashboard/organisation/branches'}>Cancel</Link>
            </Button>
          </CardFooter>
        </Card>
      </form>
