            ...
            <Card>
              <CardHeader className='border-border/50 flex flex-col gap-4 border-b pb-4 sm:flex-row sm:items-center sm:justify-between'>
                <div>
                  ...
                  <CardDescription>
                    {draftCourses.length} draft course{draftCourses.length === 1 ? '' : 's'} owned
                    by this creator.
                  </CardDescription>
                </div>
              </CardHeader>
                ...
                {draftCourses?.length >= 1 && (
                  ...
                  <Square size={20} strokeWidth={1} className='mx-auto flex self-center' />
                      ...
                      <TableBody className='pb-12'>
                        {(draftCourses as unknown as DraftCourseItem[])?.map(
                          (course: DraftCourseItem) => (
                    ...
                    <Square size={20} strokeWidth={1} className='mx-auto flex self-center' />
                              ...
                              <TableCell className='py-1'>
                                <Image
                                  src={
                                    toAuthenticatedMediaUrl(course?.thumbnail_url as string) ||
                                    '/illustration.png'
                                  }
                                  alt='thumbnail'
                                  width={48}
                              ...
                              <TableCell className='text-center'>
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align='end'>
                                    ...
                                    <DropdownMenuItem
                                      onClick={() =>
                                        course.uuid && handlePublishCourse(course.uuid)
                                      }
                                    ...
                                    <DropdownMenuItem
                                      variant='destructive'
                                      onClick={() => course.uuid && handleDeleteCourse(course.uuid)}
                                    >
