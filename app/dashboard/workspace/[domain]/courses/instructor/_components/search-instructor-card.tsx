...
// async function getLocation(instructor: SearchInstructor) {
//   if (instructor.formatted_location) {
//     return instructor.formatted_location;
//   }

//   if (instructor.location?.city) {
//     return instructor.location.city;
//   }

//   if (instructor.latitude && instructor.latitude) {
//     return await getLocationFromCoords({
//       lat: instructor.latitude as number,
//       lng: instructor.longitude as number,
//     });
//   }
...
export function SearchInstructorCard({
  instructor,
  courseId,
  selected,
  onSelect,
