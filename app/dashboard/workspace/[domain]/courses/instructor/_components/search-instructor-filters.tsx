  ...
  return (
    <Card className='rounded-md border bg-card p-4'>
      <div className='flex flex-col gap-3 lg:flex-row lg:items-center'>
        <div className='relative flex-1'>
          ...
          <Input
            ...
            className='h-10 rounded-md pl-10 text-sm sm:text-base'
          />
        </div>

        <Button type='button' variant='default' className='h-10 rounded-md px-6' onClick={onApply}>
          Search
        </Button>
      </div>
      ...
      <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end'>
        ...
        <Button type='button' className='h-9 rounded-md px-4 text-sm' onClick={onApply}>
          Apply Filters
        </Button>
      </div>
    </Card>
