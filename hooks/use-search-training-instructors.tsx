...
function useSearchTrainingInstructors() {
    const { data, isLoading: isInstructorsLoading, isError, isFetching } = useQuery({
        ...getAllInstructorsOptions({
    ...
    const loading =
        isInstructorsLoading || isFetching || isProfilesLoading || isExperiencesLoading || isSkillsLoading;
